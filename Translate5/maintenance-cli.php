...
use Translate5\MaintenanceCli\Command\{AuthTokenCommand,
    ...
    L10nCleanupXliffsCommand,
    L10nExchangeSourcesCommand,
    L10nExtractCommand,
    L10nFormatCommand,
    L10nReimportCommand,
    ...
    OkapiAcrossPatchAbbrevationsCommand,
    OkapiAddCommand,
    ...
    T5Memory\ScheduleConversionForAllCommand,
    ...
    T5connect\T5connectSetForeignStateCommand,
    TaskArchiveCommand,
    TaskChangesCommand,
    TaskCleanCommand,
    TaskConfigCommand,
    TaskDataDownloadCommand,
    TaskExportCleanCommand,
    TaskExportCommand,
    TaskFromInstantTranslateCommand,
    TaskImportCommand,
    TaskInfoCommand,
    TaskLogCommand,
    TaskSegmentStatisticsCommand,
    TaskSkeletonfileCommand,
    TaskStateUnconfirmCommand,
    TaskUnlockCommand,
    TbxCleanCommand,
...
$commands = [
    ...
    new LogCommand(),
    new LogToJiraCommand(),
    new LogPhpCommand(),
    new LogWorkerCommand(),
    new LogLoginCommand(),
    new LogPhpCommand(),
    new LogWorkerCommand(),
    new L10nCleanupXliffsCommand(),
    new L10nExchangeSourcesCommand(),
    ...
    new RoleListCommand(),
    new ScheduleConversionForAllCommand(),
