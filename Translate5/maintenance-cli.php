...
use Translate5\MaintenanceCli\Command\{CachePurgeCommand,ChangelogCommand,ConfigCommand,DatabaseUpdateCommand,DevelopmentCreatetestCommand,DevelopmentEcodeCommand,DevelopmentGithookCommand,DevelopmentNewModelCommand,DevelopmentNewdbchangeCommand,DevelopmentTriggerworkflowCommand,DevelopmentOkapiBconfNextVersionCommand,L10nAddCommand,L10nRemoveCommand,LogCommand,MaintenanceAnnounceCommand,MaintenanceNotifyCommand,MaintenanceCommand,MaintenanceDisableCommand,MaintenanceMessageCommand,MaintenanceSetCommand,OpenTm2MigrationCommand,PluginDisableCommand,PluginEnableCommand,PluginListCommand,ReleaseNotesCommand,SessionImpersonateCommand,StatusCommand,SystemCheckCommand,SystemMailtestCommand,TaskCleanCommand,TaskInfoCommand,TaskSkeletonfileCommand,TermportalReindexCommand,TermportalDatatypecheckCommand,TestRunAllCommand,TestRunCommand,TestRunSuiteCommand,TestApplicationRunCommand,TestAddIniSectionCommand,TestCleanupCommand,UserCreateCommand,UserInfoCommand,WorkerCleanCommand,WorkerListCommand,WorkerQueueCommand};
