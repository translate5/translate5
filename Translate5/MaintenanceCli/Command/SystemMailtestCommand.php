...
class SystemMailtestCommand extends Translate5AbstractCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $configCollection[] = [
            'runtimeOptions.sendMailLocally' => $config->runtimeOptions->sendMailLocally,
        ];
        $configCollection[] = [
            'runtimeOptions.sendMailDisabled' => $config->runtimeOptions->sendMailDisabled,
        ];
        $configCollection[] = [
            'runtimeOptions.defines.EMAIL_REGEX' => $config->runtimeOptions->defines->EMAIL_REGEX,
        ];
        $configCollection[] = [
            'runtimeOptions.translation.applicationLocale' => $config->runtimeOptions->translation->applicationLocale,
        ];
        $configCollection[] = [
            'runtimeOptions.translation.fallbackLocale' => $config->runtimeOptions->translation->fallbackLocale,
        ];
