...
class DevelopmentLocalServicesCommand extends ServiceAutodiscoveryCommand
{
    ...
    protected array $services = [
        'php' => [
            ...
            'config' => [
                'remove' => true,
            ], // will remove the worker-config as the server url works for local dev
        ],
        't5memory' => [
        ...
        'frontendmessagebus' => [
            ...
            'config' => [
                'socketServer' => 'ws://localhost:4756/translate5',
            ], // special host/port for local-dev
        ],
        'okapi' => [
            'url' => 'http://localhost:4780',
            'config' => [
                'keepAll' => true,
            ], // for dev we want all okapi versions in the container
        ],
        'languagetool' => [
            'url' => [
