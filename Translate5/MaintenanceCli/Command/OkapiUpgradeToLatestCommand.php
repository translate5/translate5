...
class OkapiUpgradeToLatestCommand extends Translate5AbstractCommand
{
    protected static $defaultName = 'okapi:upgrade-to-latest';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($upgrade->update()) {
            ...
            $this->io->warning($upgrade->getMessages());
        }
