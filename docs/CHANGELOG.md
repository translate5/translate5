...
### Added
**[TRANSLATE-3361](https://jira.translate5.net/browse/TRANSLATE-3361): Main back-end mechanisms (Worker, Logging, etc.) - Speed up initial loading of translate5** <br>
7.41.1: BETA role out build JS files for faster application loading - currently disabled must be enabled in application.ini


### Changed
**[TRANSLATE-5362](https://jira.translate5.net/browse/TRANSLATE-5362): Import/Export - COTI: Use more fields from COTI.xml as task params** <br>
7.41.1: Fix to re-enable usage of custom fields UI
7.38.0: Use more fields from COTI.xml as task params


### Bugfixes
**[TRANSLATE-5664](https://jira.translate5.net/browse/TRANSLATE-5664): Editor general - Remove obsolete worker API endpoint** <br>
7.41.1: Removed an obsolete worker API endpoint that is no longer required for background processing.
7.40.6: Just disabled the endpoint in the backport release

**[TRANSLATE-5663](https://jira.translate5.net/browse/TRANSLATE-5663): Editor general - Avoid exposing internal PHP error details in REST responses** <br>
Reduced internal diagnostic details returned in REST error responses.

**[TRANSLATE-5662](https://jira.translate5.net/browse/TRANSLATE-5662): Editor general - Sanitize task custom field schema updates** <br>
Fixed unsafe SQL generation when creating task custom fields.

**[TRANSLATE-5661](https://jira.translate5.net/browse/TRANSLATE-5661): Editor general - Improve XLIFF import metadata parsing** <br>
Improved parsing of translate5-specific XLIFF metadata during import.

**[TRANSLATE-5641](https://jira.translate5.net/browse/TRANSLATE-5641): Editor general - Add Logging and warning if a segment saving does not save the actual content (presumably due to mobile network latencies)** <br>
7.40.6 / 7.41.1: FIX: Detected segment savings that actually are not saved are only logged due to many false-positive detections 
7.40.5: FIX: Add detection and warning of segment savings that actually were not saved presumably due to high mobile network latencies

**[TRANSLATE-5601](https://jira.translate5.net/browse/TRANSLATE-5601): VisualReview / VisualTranslation - Visual: Pretranslation of WYSIWYG stops when left frame is invisible** <br>
FIX: Prestranslation of WYSIWYG may fails if left frame of the visual is hidden
...
7.41.1: general role out of the feature
7.29.6: The materialized views of per task segment data are created as innodb tables and cleaned up daily only now
...
### Added
**[TRANSLATE-5226](https://jira.translate5.net/browse/TRANSLATE-5226): translate5 AI - Speed up of AI-based pre-translations by parallelization of requests to the AI** <br>
Improve pre-translation speed when using AI resources.

**[TRANSLATE-4986](https://jira.translate5.net/browse/TRANSLATE-4986): InstantTranslate - SSO: add possibility to define multiple clients for user** <br>
7.41.0: arrays of clients are directly supported, not only comma separated lists
7.40.5: Make role validation more flexible for special use cases
7.37.4: The custom customer claim now supports multiple customers as coma separated values.


### Changed
**[TRANSLATE-5630](https://jira.translate5.net/browse/TRANSLATE-5630): MatchAnalysis & Pretranslation - Add test to cover pre-translation of repetitions with MT resource** <br>
Provide additional tests

**[TRANSLATE-5543](https://jira.translate5.net/browse/TRANSLATE-5543): Main back-end mechanisms (Worker, Logging, etc.) - Change theRootCause.io error-window** <br>
When error pops, user will now be informed about that re-login is needed, and logout is now done on error submit


### Bugfixes
**[TRANSLATE-5656](https://jira.translate5.net/browse/TRANSLATE-5656): Editor general - Correct Dari language direction flag** <br>
Corrected the Dari language direction flag so Dari is handled as right to left.

**[TRANSLATE-5651](https://jira.translate5.net/browse/TRANSLATE-5651): Editor general - Introduce reusable frontend logging component** <br>
Improve frontend diagnostics by centralizing custom and system log submission in a reusable JavaScript component.

**[TRANSLATE-5574](https://jira.translate5.net/browse/TRANSLATE-5574): TermPortal - TermPortal solve XSS attack vectors** <br>
7.41.0: Correct some string sanitations and fixed some translations
7.39.1: Fixed some XSS vulnerabilities in Termportal

**[TRANSLATE-5547](https://jira.translate5.net/browse/TRANSLATE-5547): Editor general - Several issues in editor** <br>
Added writing debug information needed for improving editor stability
...
### Changed
**[TRANSLATE-5646](https://jira.translate5.net/browse/TRANSLATE-5646): Hotfolder Import - Notify responsible manager for Hotfolder task export fails** <br>
Notify responsible manager if hotfolder task export fails

**[TRANSLATE-5597](https://jira.translate5.net/browse/TRANSLATE-5597): Installation & Update - Implement per-package integrity manifests for installation integrity checks** <br>
...
New feature where we can configure if the protected content will be exported as tags or un-protected.


### Bugfixes
**[TRANSLATE-5643](https://jira.translate5.net/browse/TRANSLATE-5643): TermTagger integration - Fix track changes handling in TermTagger integration logic** <br>
Fix track changes handling in TermTagger integration logic

**[TRANSLATE-5641](https://jira.translate5.net/browse/TRANSLATE-5641): Editor general - Add Logging and warning if a segment saving does not save the actual content (presumably due to mobile network latencies)** <br>
FIX: Add detection and warning of segment savings that actually were not saved presumably due to high mobile network latencies

**[TRANSLATE-5635](https://jira.translate5.net/browse/TRANSLATE-5635): Editor general - JS: document-selection-wrong-position {"range":{"start":{"root":"main","path":[0,65],"stickiness":"toNone"},"end":{"root":"main","path":[0,65],"stickin...** <br>
7.40.5: Fixed another small bug introduced with previous bugfix
7.40.4: Fixed error which may caused some segments to cause error on opening. Fixed bug with calculating pixel length for some unicode characters.

**[TRANSLATE-5625](https://jira.translate5.net/browse/TRANSLATE-5625): Hotfolder Import - Add command to initiate HOTFOLDER exports by CLI** <br>
Add command to trigger Hotfolder-exports via CLI

**[TRANSLATE-5623](https://jira.translate5.net/browse/TRANSLATE-5623): TermPortal - RootCause: Cannot read properties of null (reading 'first')** <br>
FIXED: added a small delay to make sure collection list component is initialized


## [7.40.4] - 2026-07-22

### Important Notes:
#### [TRANSLATE-5553](https://jira.translate5.net/browse/TRANSLATE-5553)
The runtimeOptions.import.fileparser.options.protectTags is removed in favour of using Okapi for doing similar things.
 


### Changed
**[TRANSLATE-5474](https://jira.translate5.net/browse/TRANSLATE-5474): usability language resources - Warn user of mismatch of language resource and task language pairs** <br>
Warn user of mismatch of language resource and task language pairs


### Bugfixes
**[TRANSLATE-5637](https://jira.translate5.net/browse/TRANSLATE-5637): job coordinator - Error on change of job step by Coordinator** <br>
Provide user friendly message for invalid job step provided by Coordinator

**[TRANSLATE-5635](https://jira.translate5.net/browse/TRANSLATE-5635): Editor general - JS: document-selection-wrong-position {"range":{"start":{"root":"main","path":[0,65],"stickiness":"toNone"},"end":{"root":"main","path":[0,65],"stickin...** <br>
Fixed error which may caused some segments to cause error on opening. Fixed bug with calculating pixel length for some unicode characters.

**[TRANSLATE-5634](https://jira.translate5.net/browse/TRANSLATE-5634): Editor general - JS: row.getHtml is not a function** <br>
UI error fixed: row.getHtml is not a function

**[TRANSLATE-5631](https://jira.translate5.net/browse/TRANSLATE-5631): General - Server Error: _clone method called on non-object** <br>
Fix logger error

**[TRANSLATE-5627](https://jira.translate5.net/browse/TRANSLATE-5627): Workflows - Workflow finished even though workflow step is still open** <br>
Fix workflow step recalculation for Coordinator group jobs

**[TRANSLATE-5624](https://jira.translate5.net/browse/TRANSLATE-5624): Editor general - Clean up stale temporary files in data/tmp and font-lib system tmp files** <br>
Stale temporary files in translate5's tmp directory and leftover font processing files are cleaned up automatically once per day.

**[TRANSLATE-5553](https://jira.translate5.net/browse/TRANSLATE-5553): Import/Export - Remove implementation and protectTags config** <br>
The runtimeOptions.import.fileparser.options.protectTags is removed in favour of using Okapi for doing similar things.

**[TRANSLATE-5545](https://jira.translate5.net/browse/TRANSLATE-5545): VisualReview / VisualTranslation - Visual: When visual is hidden, highlighting a segment may triggers an JS-error** <br>
FIX: When visual is hidden, highlighting/selecting a segment may causes a JS error

**[TRANSLATE-5510](https://jira.translate5.net/browse/TRANSLATE-5510): LanguageResources, Workflows - locked segments will be saved to master TM on workflow finish** <br>
Added ignoring locked segments during reimporting segments to master TM on task finish
...
### Bugfixes
**[TRANSLATE-5626](https://jira.translate5.net/browse/TRANSLATE-5626): MatchAnalysis & Pretranslation - Repetition propagation: wrong tag sequence used** <br>
Fixed repetition propagation in pre-translation for MT resources

**[TRANSLATE-5541](https://jira.translate5.net/browse/TRANSLATE-5541): file format settings - CSV import does not work with OKAPI nor with the internal CSV parser** <br>
FIX: csv-files could not be imported anymore because OKAPIs okf_multiparser Filter does not work properly, use okf_table_csv instead.
FIX: internal CSV parser to properly process UTF-8 files with BOM
...
### Bugfixes
**[TRANSLATE-5620](https://jira.translate5.net/browse/TRANSLATE-5620): Editor general - XLIFF tag dialects: missing text on result restore when a paired tag carries the placeable marker** <br>
Fix for a problem where decoding protected content can wrongly evaluate non protected/placeable tags.

**[TRANSLATE-5619](https://jira.translate5.net/browse/TRANSLATE-5619): t5memory - Error on import of TMX file with whitespaces in name** <br>
Error was popping on import of TMX file with whitespaces in name.
Issue is now fixed
...
### Changed
**[TRANSLATE-5324](https://jira.translate5.net/browse/TRANSLATE-5324): TermPortal - Fetching attributes for all terms in a termEntry** <br>
TermPortal HTTP API response is now ready to work with simplified UI → already in 7.40.0 but missed in changelog

**[TRANSLATE-5159](https://jira.translate5.net/browse/TRANSLATE-5159): TermPortal - Link custom attributes to specific TermCollection** <br>
custom/proprietary attribute datatypes are now linked only to TermCollections these datatypes were originating from → already in 7.40.0 but missed in changelog


### Bugfixes
**[TRANSLATE-5618](https://jira.translate5.net/browse/TRANSLATE-5618): TM Maintenance - Editor banner is visible in tm maintenance** <br>
Removed Rich Text Editor banner in TM Maintenance interface

**[TRANSLATE-5616](https://jira.translate5.net/browse/TRANSLATE-5616): TrackChanges - Unable to delete characters at segment start in case trackchanges are invisible** <br>
Fixed error which may prevent characters at the beginning of the segment to be deleted if trackchanges are active, but invisible for user or hidden.

**[TRANSLATE-5615](https://jira.translate5.net/browse/TRANSLATE-5615): Editor general - Editing History Export is Broken in case a Language-Resource was deleted** <br>
FIX: Editing history export failed when language-resource used for pretranslation was deleted

**[TRANSLATE-5589](https://jira.translate5.net/browse/TRANSLATE-5589): ConnectWorldserver - Private Plugin ConnectWorldserver. Set task lockLocked** <br>
Plugin ConnectWorldserver now sets attribute "lockLocked" on creating projects/tasks. Then sdlxliff locked segments are also locked in Translate5.

**[TRANSLATE-5504](https://jira.translate5.net/browse/TRANSLATE-5504): Editor general - Fix "Open next segment" logic** <br>
Fix "Open next segment" logic


## [7.40.0] - 2026-07-12

### Important Notes:
#### [TRANSLATE-5213](https://jira.translate5.net/browse/TRANSLATE-5213)
Introduce a slim user friendly TermPortal for term searchers.
If you have customized UI texts via client-specific overwrite please contact us before installing this release.
 


### Added
**[TRANSLATE-5472](https://jira.translate5.net/browse/TRANSLATE-5472): TermPortal - Per-level visiblity for basic & proprietary attributes, and for properties** <br>
Added ability to define per-level visibility for static properties and attribute datatypes

**[TRANSLATE-5443](https://jira.translate5.net/browse/TRANSLATE-5443): KPI Statistics - New editor columns for Levenshtein and post-editing time** <br>
New segment columns for levenshtein and post editing statistics.

**[TRANSLATE-5289](https://jira.translate5.net/browse/TRANSLATE-5289): kpi - Export Levenshtein distance, post-editing time and TQE in "Export editing history per workflow step"** <br>
Levenshtein distance and post editing time is included in editing history export.

**[TRANSLATE-5213](https://jira.translate5.net/browse/TRANSLATE-5213): TermPortal - TermPortal: Very simple UI for "search only"** <br>
Introduce a slim user friendly TermPortal for term searchers.

**[TRANSLATE-4441](https://jira.translate5.net/browse/TRANSLATE-4441): LanguageResources, TermPortal - TermCollection statistics** <br>
Introduce statistics for TermCollections

**[TRANSLATE-3034](https://jira.translate5.net/browse/TRANSLATE-3034): TermPortal - Manage custom attributes in TermPortal GUI** <br>
Added ability to create/update/delete proprietary attribute datatypes


### Changed
**[TRANSLATE-5594](https://jira.translate5.net/browse/TRANSLATE-5594): Editor general - Show "Leave task" popup even if task has critical QA errors** <br>
Show "Leave task" popup even if task has critical QA errors, still an information about the QA errors is popping up.

**[TRANSLATE-5544](https://jira.translate5.net/browse/TRANSLATE-5544): Package Ex and Re-Import - Improve user permissions for Translator package export** <br>
Improve user permissions for Translator package export

**[TRANSLATE-5413](https://jira.translate5.net/browse/TRANSLATE-5413): MatchAnalysis & Pretranslation - pretranslate internal fuzzy** <br>
Do not skip pre-translation of segments if internal fuzzy is active.


### Bugfixes
**[TRANSLATE-5584](https://jira.translate5.net/browse/TRANSLATE-5584): Workflows - job coordinator does not receive finish job notification** <br>
Make it possible for Coordinator to receive e-mail when group user finishes his job
...
### Changed
**[TRANSLATE-5609](https://jira.translate5.net/browse/TRANSLATE-5609): Hotfolder Import - Add retry for filesystem operations** <br>
Add retry for filesystem operations

**[TRANSLATE-5534](https://jira.translate5.net/browse/TRANSLATE-5534): Editor general, TermTagger integration - Improve terms markup** <br>
Improved styling for terms markup.

**[TRANSLATE-5483](https://jira.translate5.net/browse/TRANSLATE-5483): SpellCheck (LanguageTool integration) - Improvements for spellchecker** <br>
Several improvements and bugfixes to the SpellChecker UI

**[TRANSLATE-5436](https://jira.translate5.net/browse/TRANSLATE-5436): User Management - Hide PM Light role** <br>
Hide PM Light role. Role is deprecated and will be removed.

**[TRANSLATE-5236](https://jira.translate5.net/browse/TRANSLATE-5236): Docker Setup - Create new docker image to build sencha applications** <br>
Create new docker image to build sencha applications


### Bugfixes
**[TRANSLATE-5588](https://jira.translate5.net/browse/TRANSLATE-5588): translate5 AI - Improve RAG Management: Post release fixes** <br>
OpenAI Rag Management Improvements:
* Add description for Exampleset-settings in the RAG
* Add SaveAs-button for prompts in the RAG


**[TRANSLATE-5577](https://jira.translate5.net/browse/TRANSLATE-5577): file format settings - OKAPI: XSLT Files are prepended before SRXs but they must be in the same order as the steps** <br>
FIX: Pipelines with an XSLT step not being the first step were invalidly packed

**[TRANSLATE-5573](https://jira.translate5.net/browse/TRANSLATE-5573): InstantTranslate, User Management - changing UI language in InstantTranslate not working** <br>
Fix problem where language switch is not working in instant-translate.

**[TRANSLATE-5554](https://jira.translate5.net/browse/TRANSLATE-5554): localization - Small Localization Problem** <br>
FIX minor localization quirk

**[TRANSLATE-5508](https://jira.translate5.net/browse/TRANSLATE-5508): Editor general - Editor history is not cleared between segments** <br>
Fixed error related to editing history which was shared between different segments editing

**[TRANSLATE-5497](https://jira.translate5.net/browse/TRANSLATE-5497): Workflows - view only role will block workflow to finish** <br>
view only jobs did block normal workflow flow, this is fixed

**[TRANSLATE-5464](https://jira.translate5.net/browse/TRANSLATE-5464): Editor general, SpellCheck (LanguageTool integration) - Spell-Check looses "ignore state" and is not always triggered** <br>
False positive state of the spellcheck error now persists after segment is saved in case it has the same position in the segment. Fixed spellcheck qualities appearing after using "Save segment and go to next".

**[TRANSLATE-5445](https://jira.translate5.net/browse/TRANSLATE-5445): SpellCheck (LanguageTool integration) - Make SpellCheck to treat segments as separate sentences** <br>
FIXED: SpellCheck now treats segments as separate sentences


## [7.39.1] - 2026-06-30

### Important Notes:
#### [TRANSLATE-5585](https://jira.translate5.net/browse/TRANSLATE-5585)
Update/pull of the translate5/okapi docker container is required
 


### Changed
**[TRANSLATE-5585](https://jira.translate5.net/browse/TRANSLATE-5585): Okapi integration - New OKAPI 1.49 snapshot 2** <br>
Added new okapi version 1.49-snapshot-2

**[TRANSLATE-5400](https://jira.translate5.net/browse/TRANSLATE-5400): t5memory - Wait to acquire lock on t5memory queries** <br>
Wait to acquire lock on t5memory queries to improve user experience in UI


### Bugfixes
**[TRANSLATE-5582](https://jira.translate5.net/browse/TRANSLATE-5582): Export - Error on Export of track changes in sdlxliff** <br>
Fix Export of track changes in sdlxliff

**[TRANSLATE-5576](https://jira.translate5.net/browse/TRANSLATE-5576): TM Maintenance - Reorganise status for search in language resource popups too often** <br>
Improve t5memory status check

**[TRANSLATE-5574](https://jira.translate5.net/browse/TRANSLATE-5574): TermPortal - TermPortal solve XSS attack vectors** <br>
7.39.1: Fixed some XSS vulnerabilities in Termportal

**[TRANSLATE-5564](https://jira.translate5.net/browse/TRANSLATE-5564): translate5 AI - FIX extJs error when refreshing segment** <br>
FIX bug with missing reference when refreshing segment

**[TRANSLATE-5528](https://jira.translate5.net/browse/TRANSLATE-5528): t5memory - TMX export dir composed incorrectly** <br>
Fix TMX export dir compose logic
...
### Changed
**[TRANSLATE-5557](https://jira.translate5.net/browse/TRANSLATE-5557): Hotfolder Import - Rename Hotfolder plugin** <br>
Rename Hotfolder plugin

**[TRANSLATE-5420](https://jira.translate5.net/browse/TRANSLATE-5420): translate5 AI - Improve RAG Management: Add "Add new prompt" Button** <br>
Improve RAG Management: Added "add prompt" button

**[TRANSLATE-5419](https://jira.translate5.net/browse/TRANSLATE-5419): translate5 AI - Improve RAG Management: Add sent prompt preview just as in training window** <br>
Improve RAG Management: Add sent prompt preview just as in training window

**[TRANSLATE-5418](https://jira.translate5.net/browse/TRANSLATE-5418): translate5 AI - Improve RAG Management: Save As, Combine Action Buttons & Title Bar** <br>
Improve RAG Management: Added "Save As", combined action buttons & prompt title bar

**[TRANSLATE-5417](https://jira.translate5.net/browse/TRANSLATE-5417): translate5 AI - Improve RAG Management: Add Reordering capabilities of Prompts via drag & drop, fix removal** <br>
Improve RAG Management: Added reordering capabilities of prompts via drag & drop

**[TRANSLATE-5416](https://jira.translate5.net/browse/TRANSLATE-5416): translate5 AI - Improve RAG Management: Remove Examples, remove "Add sys message"** <br>
Improve RAG Management: Remove Examples, remove "Add sys message"

**[TRANSLATE-5415](https://jira.translate5.net/browse/TRANSLATE-5415): translate5 AI - Translate5 AI: Improve RAG prompt management** <br>
Translate5 AI: Improved usability of RAG prompt management and solve sluggish UI problems due to too much components in the UI

**[TRANSLATE-5273](https://jira.translate5.net/browse/TRANSLATE-5273): Editor general - Tag-Conversation-Dialect: xliff** <br>
New tag conversion dialect Xliff and introduce repair capabilities for it.

**[TRANSLATE-5272](https://jira.translate5.net/browse/TRANSLATE-5272): Editor general - Tag conversation dialect** <br>
Introduce resource dialects. Configurable option for language resource where it is sellectable how resource talks to AI, MT etc.

**[TRANSLATE-5271](https://jira.translate5.net/browse/TRANSLATE-5271): Editor general - Xml tag repair: advance tag repair strategy** <br>
New repair strategy where missing or misplaced tags are proportionally placed based on source tag possition.

**[TRANSLATE-3666](https://jira.translate5.net/browse/TRANSLATE-3666): LanguageResources - Placeables and Content protection: Use placeables content also when requesting LLMs** <br>
...
7.39.0: Additional improvements, see separate issues in this release
7.36.1: Send valid xml tags with the xml paired tags tag dialect
...
### Bugfixes
**[TRANSLATE-5568](https://jira.translate5.net/browse/TRANSLATE-5568): Editor general - Prevent "Rich Text Editor" label appearing inside target segments** <br>
Fixed an issue where "Rich Text Editor" could appear inside opened target segments with a general approach (outdated assets in cache).


**[TRANSLATE-5550](https://jira.translate5.net/browse/TRANSLATE-5550): InstantTranslate, User Management - download of human-revised file restricted for InstantTranslate user** <br>
Enable export for human revision tasks for users with human revision roles.


## [7.38.0] - 2026-06-22

### Important Notes:
#### [TRANSLATE-5490](https://jira.translate5.net/browse/TRANSLATE-5490)
Update/pull of the translate5/okapi docker container is required
 


### Changed
**[TRANSLATE-5505](https://jira.translate5.net/browse/TRANSLATE-5505): Editor general - Remove check that prohibits saving an empty segment** <br>
Allow saving of empty segments

**[TRANSLATE-5490](https://jira.translate5.net/browse/TRANSLATE-5490): Okapi integration - Make okapi-longhorn_all-platforms_1.49.0-SNAPSHOT-2026-06-08 the new default in translate5** <br>
Added new okapi version 1.49-snapshot-1

**[TRANSLATE-5362](https://jira.translate5.net/browse/TRANSLATE-5362): Import/Export - COTI: Use more fields from COTI.xml as task params** <br>
Use more fields from COTI.xml as task params

**[TRANSLATE-5178](https://jira.translate5.net/browse/TRANSLATE-5178): Export - Export all tasks of a project from project menu** <br>
Added ability to export tasks of a project from project menu

**[TRANSLATE-4474](https://jira.translate5.net/browse/TRANSLATE-4474): LanguageResources - add new languages** <br>
Added Tigrinya languages to language list.
...
### Changed
**[TRANSLATE-5531](https://jira.translate5.net/browse/TRANSLATE-5531): Editor general, Workflows - Add writing log when executing callback on workflow finish** <br>
Added writing a log record when workflow is finished and there is a callback URL configured for 'handleAllFinishOfARole'.

**[TRANSLATE-5524](https://jira.translate5.net/browse/TRANSLATE-5524): TermTagger integration - Add sublanguages where stemming is disabled for term tagging** <br>
Add sublanguages where stemming is disabled for term tagging

**[TRANSLATE-5490](https://jira.translate5.net/browse/TRANSLATE-5490): Okapi integration - Make okapi-longhorn_all-platforms_1.49.0-SNAPSHOT-2026-06-08 the new default in translate5** <br>
Added new okapi version 1.49-snapshot-1

**[TRANSLATE-5435](https://jira.translate5.net/browse/TRANSLATE-5435): InstantTranslate - Make instant translate result to be editable** <br>
MT results in Instant Translate are editable now. 


### Bugfixes
**[TRANSLATE-5555](https://jira.translate5.net/browse/TRANSLATE-5555): Task Management - Prevent browser crash when importing very large task files** <br>
Very large task import files no longer cause the browser to crash during upload preparation.

**[TRANSLATE-5546](https://jira.translate5.net/browse/TRANSLATE-5546): t5connect - Detect project-name from T5Connect bundledTasks** <br>
Private Plugin:
Improve detection of the projectname to sync Status to Plunet

**[TRANSLATE-5538](https://jira.translate5.net/browse/TRANSLATE-5538): Editor general - Spaces are not rendered at the end of each line** <br>
Fixed rendering of a space (in case of space visibility enabled) when segment is opened for editing.

**[TRANSLATE-5537](https://jira.translate5.net/browse/TRANSLATE-5537): file format settings - Create OKAPI Command to search for strings in aspects of all BCONFs of an instance** <br>
OKAPI: Add CLI command to search all BCONFs of an instance

**[TRANSLATE-5523](https://jira.translate5.net/browse/TRANSLATE-5523): Authentication - IP-based user garbage collector deletes tasks that are still being imported** <br>
Fix for a problem where IP based users which is also PM of a task can produce errors

**[TRANSLATE-5520](https://jira.translate5.net/browse/TRANSLATE-5520): t5memory - Error message when initiating search in specific translation memories** <br>
Fix concordance search memory init

**[TRANSLATE-5266](https://jira.translate5.net/browse/TRANSLATE-5266): Task Management, Workflows - task state not respecting workflow state when last step deleted** <br>
Fix behaviour of task job delete

**[TRANSLATE-4323](https://jira.translate5.net/browse/TRANSLATE-4323): Editor general - moved tags inserted as text after external editing in excel** <br>
Excel reimport lost tags when importing with track changes.
...
### Bugfixes
**[TRANSLATE-5522](https://jira.translate5.net/browse/TRANSLATE-5522): Editor general, SpellCheck (LanguageTool integration) - Part of segment can disappear after spellcheck markup is applied** <br>
Fixed error which caused segment content to disappear if segment contains certain special characters

**[TRANSLATE-5514](https://jira.translate5.net/browse/TRANSLATE-5514): Editor general - Crash on editing source text** <br>
Fixed error that might have occurred in SpellChecker under certain circumstances when opening segment source for editing

**[TRANSLATE-5506](https://jira.translate5.net/browse/TRANSLATE-5506): Editor general - trailing space deleted on opening segment for editing** <br>
Fixed error when trailing space might have been cut on segment open for editing
...
### Bugfixes
**[TRANSLATE-5515](https://jira.translate5.net/browse/TRANSLATE-5515): Excel ex- and re-import - Refactor Excel reimport tag handling and harden unknown tag cleanup** <br>
Improved Excel reimport stability by refactoring tag processing and automatically removing unresolved placeholder tags with user-visible warning.

**[TRANSLATE-5512](https://jira.translate5.net/browse/TRANSLATE-5512): Workflows - New open job do not change task workflow** <br>
Fix workflow behaviour on new open job

**[TRANSLATE-5509](https://jira.translate5.net/browse/TRANSLATE-5509): Editor general - Wrong tab when opening segment for editing** <br>
Fixed selecting Fuzzy match tab when opening a segment for editing

**[TRANSLATE-5401](https://jira.translate5.net/browse/TRANSLATE-5401): t5memory - Queryable memories collected incorrectly in fuzzy search** <br>
Fix reorganise status check when collecting memories for fuzzy search

**[TRANSLATE-5380](https://jira.translate5.net/browse/TRANSLATE-5380): MatchAnalysis & Pretranslation - autopropagate repetitions** <br>
Auto-propagate repetitions in pre-translation
...
### Added
**[TRANSLATE-4986](https://jira.translate5.net/browse/TRANSLATE-4986): InstantTranslate - SSO: add possibility to define multiple clients for user** <br>
The custom customer claim now supports multiple customers as coma separated values.


### Changed
**[TRANSLATE-5438](https://jira.translate5.net/browse/TRANSLATE-5438): Translate5 CLI - Improve Araya TMX import conversion CLI** <br>
Change ⇡superscript↡ and ⇣subscript↡ to propper bpt-/ept-tag pairs for <sup>supperscript</sup> and <sub>subscript</sub>



### Bugfixes
**[TRANSLATE-5482](https://jira.translate5.net/browse/TRANSLATE-5482): Editor general - rename column title to source editable** <br>
FIX: Proper column title for the "editable source" column

**[TRANSLATE-5451](https://jira.translate5.net/browse/TRANSLATE-5451): Editor general - URLs out of config must be added automatically to HTTP CSP rules** <br>
If there are custom help pages configured the URLs are now automatically allowed by CSP header rules.

**[TRANSLATE-5403](https://jira.translate5.net/browse/TRANSLATE-5403): Editor general, TrackChanges - Error in trackchanges controller** <br>
Fixed error that might have appeared in certain cases if trackchanges is disabled for task
...
### Changed
**[TRANSLATE-5446](https://jira.translate5.net/browse/TRANSLATE-5446): TrackChanges - Highlight comments with same per-user colors as track changes** <br>
Comments in left and right panels of segment grid are now highlighted with same colors as trackchanges - i.e. different colors per different authors


### Bugfixes
**[TRANSLATE-5496](https://jira.translate5.net/browse/TRANSLATE-5496): t5memory - Bug in process of Segment delete in t5memory** <br>
Fix process of segment deletion in t5memory

**[TRANSLATE-5495](https://jira.translate5.net/browse/TRANSLATE-5495): MatchAnalysis & Pretranslation - Fuzzy in pivot pre-translation doesn't wait for available status of TM** <br>
Make fuzzy search in pivot pre-translation wait for available status of TM

**[TRANSLATE-5494](https://jira.translate5.net/browse/TRANSLATE-5494): SpellCheck (LanguageTool integration) - When spellcheck error is next to a tag it swallows a space before** <br>
Fixed SpellCheker error which might have caused spaces before a tag to disappear when spellchech markup is applied in opened editor

**[TRANSLATE-5491](https://jira.translate5.net/browse/TRANSLATE-5491): t5memory - Additional tags from TM processed incorrectly** <br>
Fix processing of Additional tags from TM

**[TRANSLATE-5485](https://jira.translate5.net/browse/TRANSLATE-5485): file format settings - File-Format-Settings: Cloned Filter/FPRM may not be shown** <br>
FIX: a cloned filter in the file-format-settings may not be shown if the filter-grid is filtered

**[TRANSLATE-5480](https://jira.translate5.net/browse/TRANSLATE-5480): InstantTranslate - Instant-Translate: fuzzy language mapping for file pre-selections** <br>
Fix file translation default pre-select when target language is not exactly matching the language variant.

**[TRANSLATE-5469](https://jira.translate5.net/browse/TRANSLATE-5469): translate5 AI - Translate5 AI: quality score column filters** <br>
Fix problem where quality score filter did not filter correct values in the segments editor.

**[TRANSLATE-5450](https://jira.translate5.net/browse/TRANSLATE-5450): TrackChanges - Accept change and go to next works wrong** <br>
Fixed jumping to the next segment with trackchange when using CTR+F9 (Accept change and jump to next)

**[TRANSLATE-5448](https://jira.translate5.net/browse/TRANSLATE-5448): Editor general - MQM tags surrounding only internal tag are removed on save** <br>
Fixed issue when MQM tags surrounding only internal tag(s) may disappear on segment save.

**[TRANSLATE-5412](https://jira.translate5.net/browse/TRANSLATE-5412): VisualReview / VisualTranslation - Visual: FIX: In Paragraphs newlines will be stripped no matter what** <br>
Stripping of newlines in paragraphs in the visual did ignore the "stripWhitespaceFromSegments" setting, this is fixed now.

**[TRANSLATE-5403](https://jira.translate5.net/browse/TRANSLATE-5403): Editor general, TrackChanges - Error in trackchanges controller** <br>
Fixed error that might have appeared in certain cases if trackchanges is disabled for task

**[TRANSLATE-5385](https://jira.translate5.net/browse/TRANSLATE-5385): Content Protection - ContentProtection DB RegEx settings should be case sensitive** <br>
ContentProtection DB RegEx field is now case sensitive
...
7.37.3: Continue aggregation when for one segment no distance could be calculated
7.35.1: Fix the calculation of the levenshtein distance of segments with internal tags.
...
### Changed
**[TRANSLATE-5421](https://jira.translate5.net/browse/TRANSLATE-5421): translate5 AI - FIX E1313 Error Message** <br>
FIX: E1313 Error message was missing the error-message

**[TRANSLATE-5414](https://jira.translate5.net/browse/TRANSLATE-5414): translate5 AI - Translate5 AI: Simplify adding language-variant of prompt** <br>
Translate5 AI: Simplified the adding of language variants for prompts


### Bugfixes
**[TRANSLATE-5488](https://jira.translate5.net/browse/TRANSLATE-5488): t5memory - cURL error 55: Send failure: Broken pipe** <br>
Add new error code for t5memory network handling

**[TRANSLATE-5487](https://jira.translate5.net/browse/TRANSLATE-5487): Workflows - User Job fetched incorrectly** <br>
Fix User Job fetching

**[TRANSLATE-5484](https://jira.translate5.net/browse/TRANSLATE-5484): Main back-end mechanisms (Worker, Logging, etc.) - Missing message ID in Mailer** <br>
The internal mailer is not setting a message ID - some relay servers are adding one automatically, some others not. In the case of not adding one the mail might be refused.

**[TRANSLATE-4691](https://jira.translate5.net/browse/TRANSLATE-4691): LanguageResources - Use paging in language resource event log** <br>
...
[🐞 Fix]  Added support of GPT-5 model
...
**[TRANSLATE-5313](https://jira.translate5.net/browse/TRANSLATE-5313): t5memory - T5Memory &nbsp; crashes import** <br>
Decode html entities on TMX import to prevent import errors


### Bugfixes
**[TRANSLATE-5330](https://jira.translate5.net/browse/TRANSLATE-5330): t5memory - Concordance search fails in certain cases** <br>
[🐞 Fix] Fix concordance search error which rarely might have occurred in certain cases
...
**[TRANSLATE-5327](https://jira.translate5.net/browse/TRANSLATE-5327): Editor general - Cannot read properties of undefined (reading 'replace') error** <br>
[🐞 Fix] Fixed warning in console when saving segment
...
**[TRANSLATE-3118](https://jira.translate5.net/browse/TRANSLATE-3118): Editor general, usability editor - Rework Richtext Editor** <br>
...
**[TRANSLATE-4358](https://jira.translate5.net/browse/TRANSLATE-4358): Hotfolder Import - Add functional test for Hotfolder** <br>
...
### Bugfixes
**[TRANSLATE-3468](https://jira.translate5.net/browse/TRANSLATE-3468): Main back-end mechanisms (Worker, Logging, etc.) - Fix Hotfolder faulty namespaces in the SQL files** <br>
...
6.3.1: New Hotfolder plugin that watches hotfolders for tasks, that should be created in translate5 - and re-exported to the hotfolder, once they are ready
...
### Added
**[TRANSLATE-3218](https://jira.translate5.net/browse/TRANSLATE-3218): API - Hotfolder-based connector solution, that mimics Across hotfolder** <br>
New Hotfolder plugin that watches hotfolders for tasks, that should be created in translate5 - and re-exported to the hotfolder, once they are ready
