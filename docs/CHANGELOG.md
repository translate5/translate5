...
### Changed
**[TRANSLATE-2450](https://jira.translate5.net/browse/TRANSLATE-2450): Live Editing: Solve problems with "unlogically" created Markup by pdfToHtml** <br>
...
* Whitespace is added, when two segments in a multiline-textfield are joined directly together
* Whitespace is added between segments when the whitespace-rendering of multiline fields is switched in case it is edited/changed
* All orphan hyphens "-" that are not part of a segment are replaced with a blank when a textfield is edited/changed. This avoids the "accumulation" of hyphens after the segments. Since a textfield in the visual review may contains more than one segment, the "orphan" hyphens of the other segments will be replaced with blanks as well.
...
[TRANSLATE-2178](https://jira.translate5.net/browse/TRANSLATE-2178): Visual Review Text-Reflow transformation of HTML generated with pdf2htmlEx failed: Operation timed out (2sec)<br>
