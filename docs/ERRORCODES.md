...
| EventCode               | Context            | EventMessage                                                                                                                                                                                     | Description/Solution                                                       |
|:------------------------|:-------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------|
| <a id="E1487"></a>E1487  | Plug-In Connect Worldserver    | did set pm-user "Manager, Project (manager)" | |
...
| <a id="E1492"></a>E1492  | Plug-In Connect Worldserver    | missing TM for this project (no value in attribute "translate5\_translation\_tmx")                                                                                                               |                                                                            |
