...
interface FileBasedInterface //extends editor_Services_Connector_Abstract
{
     ...
     * @var integer
     */
    public const EXACT_MATCH_VALUE = 100;
     ...
     * @var integer
     */
    public const EXACT_EXACT_MATCH_VALUE = 101;
