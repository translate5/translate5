...
namespace MittagQI\Translate5\CoordinatorGroup\Contract;
...
interface CoordinatorGroupUnassignCustomerOperationInterface
{
    /**
     * @throws CoordinatorGroupHasUnDeletableJobException
     */
