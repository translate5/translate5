...
class CoordinatorGroupUserCreateOperation
{
    ...
    public function createCoordinatorGroupUser(CoordinatorGroup $group, User $user): CoordinatorGroupUser
    {
        $groupUser = new CoordinatorGroupUser($user->getUserGuid(), $user, $group);

        $this->coordinatorGroupUserRepository->save($groupUser);
