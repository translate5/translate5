...
class NotMappedFieldsCollector extends AbstractTranslationUnitFileCollector
{
    ...
    public function writeLog(ZfExtended_Logger $logger, array $extra = []): void
    {
        ...
        $logger->warn(
            self::logCode(),
            'Some translation units had properties or attributes that could not be mapped to t5memory TMX structure',
            $extra,
        );
    }
