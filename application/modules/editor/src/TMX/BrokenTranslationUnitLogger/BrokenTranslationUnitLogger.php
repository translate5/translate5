...
namespace MittagQI\Translate5\TMX\BrokenTranslationUnitLogger;

use editor_Models_LanguageResources_LanguageResource as LanguageResource;
use MittagQI\Translate5\TMX\BrokenTranslationUnitLogger\Contract\BrokenTranslationUnitLoggerInterface;
use ZfExtended_Logger;

class BrokenTranslationUnitLogger implements BrokenTranslationUnitLoggerInterface
{
    /**
     * @param Contract\TranslationUnitCollectorInterface[] $collectors
     */
    ...
    {
        foreach ($this->collectors as $collector) {
            $collector->writeLog($this->logger, [
