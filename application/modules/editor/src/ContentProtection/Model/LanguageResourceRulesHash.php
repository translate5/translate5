...
use MittagQI\Translate5\ContentProtection\Model\Db\LanguageResourceRulesHashTable;
use Zend_Db_Table_Row_Abstract;
use ZfExtended_Models_Entity_Abstract;

/**
 * Indicates current state of rules for language resource
 *
...
{
    protected $dbInstanceClass = LanguageResourceRulesHashTable::class;
