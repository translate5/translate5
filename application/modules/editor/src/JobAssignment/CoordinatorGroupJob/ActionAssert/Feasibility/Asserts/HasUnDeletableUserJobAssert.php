...
namespace MittagQI\Translate5\JobAssignment\CoordinatorGroupJob\ActionAssert\Feasibility\Asserts;
...
/**
 * @implements FeasibilityAssertInterface<CoordinatorGroupJob>
 */
class HasUnDeletableUserJobAssert implements FeasibilityAssertInterface
{
    ...
    {
        try {
            foreach ($this->userJobRepository->getUserJobsByCoordinatorGroupJob((int) $object->getId()) as $job) {
