...
namespace MittagQI\Translate5\JobAssignment\CoordinatorGroupJob\ActionAssert\Feasibility;
...
use MittagQI\Translate5\JobAssignment\CoordinatorGroupJob\ActionAssert\Feasibility\Asserts\HasUnDeletableUserJobAssert;
...
/**
 * @extends ActionFeasibilityAssert<CoordinatorGroupJob>
 */
final class CoordinatorGroupJobActionFeasibilityAssert extends ActionFeasibilityAssert
{
    /**
    ...
    public function assertAllowed(Action $action, object $object): void
    {
        ...
        foreach ($this->coordinatorGroupJobRepository->getSubGroupJobsOf((int) $object->getId()) as $subJob) {
