...
namespace MittagQI\Translate5\JobAssignment\CoordinatorGroupJob\Model;
 ...
 */
class CoordinatorGroupJob extends ZfExtended_Models_Entity_Abstract
{
    protected $dbInstanceClass = CoordinatorGroupJobTable::class;
}
