 ...
 */
class CoordinatorGroupUserJobAssert implements PermissionAssertInterface
{
    ...
    public function assertGranted(\BackedEnum $action, object $object, PermissionAssertContext $context): void
    {
        ...
        $groupUser = $this->coordinatorGroupUserRepository->findByUserGuid($object->getUserGuid());
