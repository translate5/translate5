...
namespace MittagQI\Translate5\JobAssignment\UserJob\ActionAssert\Feasibility\Asserts;
 ...
 */
class TaskOfJobIsLockedByUserAssert implements FeasibilityAssertInterface
{
    ...
    public function assertAllowed(object $object): void
    {
        ...
        if ($task->isLocked($object->getTaskGuid(), $object->getUserGuid())) {
            throw new AttemptToRemoveJobWhichTaskIsLockedByUserException($object);
        }
    }
}
