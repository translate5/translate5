...
class SearchQueryDtoFactory
{
    ...
    public function fromRequest(Zend_Controller_Request_Abstract $request): SearchQueryDto
    {
        ...
        return new SearchQueryDto(
            $params['taskGuid'],
            $params['searchInField'] ?? editor_Models_Segment::DEFAULT_SEARCH_FIELD,
            $params['searchType'] ?? editor_Models_Segment::DEFAULT_SEARCH_TYPE,
            $searchField,
            strtolower($params['matchCase'] ?? '') == 'true',
            ($params['searchInLockedSegments'] ?? '') === 'true',
            $filter,
        );
    }
     ...
     */
    protected function checkSearchStringLength(string $searchField): void
    {
