...
class TagValidationTracking
{
    ...
    {
        file_put_contents($this->getStatusFilePath(), $status);
    }
    ...
    public function getStatus(): string
    {
        ...
        return file_exists($statusFile) ? file_get_contents($statusFile) : self::OK;
    }
    ...
    {
        return $this->task->getAbsoluteTaskDataPath() . '/finalizeSegmentsStatusByUser' . $this->userId;
    }
}
