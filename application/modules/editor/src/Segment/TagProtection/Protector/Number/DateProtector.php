...
class DateProtector extends AbstractProtector
{
    ...
    private array $dateFormats = [
        [
            'regex' => '\d{4}\/(0[1-9]|[1-2][0-9]|3[0-1]|[1-9])\/(0[1-9]|1[0-2]|[1-9])',
            'format' => 'Y/d/m'
        ],
        [
            'regex' => '\d{4}-(0[1-9]|[1-2][0-9]|3[0-1]|[1-9])-(0[1-9]|1[0-2]|[1-9])',
        ...
        [
            'regex' => '(0[1-9]|[1-2][0-9]|3[0-1]|[1-9])\/(0[1-9]|1[0-2]|[1-9])\/\d{4}',
            'format' => 'd/m/Y'
        ],
        [
            'regex' => '(0[1-9]|[1-2][0-9]|3[0-1]|[1-9])-(0[1-9]|1[0-2]|[1-9])-\d{4}',
        ...
        [
            'regex' => '(0[1-9]|[1-2][0-9]|3[0-1]|[1-9])\/(0[1-9]|1[0-2]|[1-9])\/\d{2}',
            'format' => 'd/m/y'
        ],
        [
            'regex' => '(0[1-9]|[1-2][0-9]|3[0-1]|[1-9])-(0[1-9]|1[0-2]|[1-9])-\d{2}',
        ...
        [
            'regex' => '\d{4}\/(0[1-9]|1[0-2]|[1-9])\/(0[1-9]|[1-2][0-9]|3[0-1]|[1-9])',
            'format' => 'Y/m/d'
        ],
        [
            'regex' => '\d{4}-(0[1-9]|1[0-2]|[1-9])-(0[1-9]|[1-2][0-9]|3[0-1]|[1-9])',
        ...
        [
            'regex' => '(0[1-9]|1[0-2]|[1-9])\/(0[1-9]|[1-2][0-9]|3[0-1]|[1-9])\/\d{4}',
            'format' => 'm/d/Y'
        ],
        [
            'regex' => '(0[1-9]|1[0-2]|[1-9])-(0[1-9]|[1-2][0-9]|3[0-1]|[1-9])-\d{4}',
        ...
        [
            'regex' => '(0[1-9]|1[0-2]|[1-9])\/(0[1-9]|[1-2][0-9]|3[0-1]|[1-9])\/\d{2}',
            'format' => 'm/d/y'
        ],
        [
            'regex' => '(0[1-9]|1[0-2]|[1-9])-(0[1-9]|[1-2][0-9]|3[0-1]|[1-9])-\d{2}',
        ...
        [
            'regex' => '\d{2}\/(0[1-9]|1[0-2]|[1-9])\/(0[1-9]|[1-2][0-9]|3[0-1]|[1-9])',
            'format' => 'y/m/d'
        ],
    ...
    protected function composeNumberTag(
        ...
        if (!empty($sourceFormat['format']) && empty($sourceFormat['keepAsIs'])) {
