...
namespace MittagQI\Translate5\DefaultJobAssignment\DefaultCoordinatorGroupJob\Model;
 ...
 * @method string getDataJobId()
 * @method void setDataJobId(int $id)
 */
class DefaultCoordinatorGroupJob extends ZfExtended_Models_Entity_Abstract
{
    protected $dbInstanceClass = DefaultCoordinatorGroupJobTable::class;
}
