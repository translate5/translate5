...
namespace MittagQI\Translate5\DefaultJobAssignment\DefaultCoordinatorGroupJob\ActionAssert\Permission;
...
/**
 * @extends ActionPermissionAssert<DefaultJobAction, DefaultCoordinatorGroupJob>
 */
class DefaultCoordinatorGroupJobActionPermissionAssert extends ActionPermissionAssert
{
    /**
     * @codeCoverageIgnore
     */
    public static function create(): self
    {
        return new self([
            ...
            CoordinatorGroupRestrictionAssert::create(),
        ]);
    }
}
