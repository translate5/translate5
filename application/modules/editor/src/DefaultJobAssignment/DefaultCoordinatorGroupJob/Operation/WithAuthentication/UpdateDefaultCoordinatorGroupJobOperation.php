...
use MittagQI\Translate5\DefaultJobAssignment\Contract\UpdateDefaultCoordinatorGroupJobOperationInterface;
...
class UpdateDefaultCoordinatorGroupJobOperation implements UpdateDefaultCoordinatorGroupJobOperationInterface
{
    public function __construct(
        private readonly ZfExtended_AuthenticationInterface $authentication,
        private readonly UserRepository $userRepository,
        private readonly UpdateDefaultCoordinatorGroupJobOperationInterface $operation,
        private readonly ActionPermissionAssertInterface $defaultCoordinatorGroupJobPermissionAssert,
    ...
    public static function create(): self
    {
        return new self(
            ...
            new UserRepository(),
            \MittagQI\Translate5\DefaultJobAssignment\DefaultCoordinatorGroupJob\Operation\UpdateDefaultCoordinatorGroupJobOperation::create(),
            DefaultCoordinatorGroupJobActionPermissionAssert::create(),
            UserActionPermissionAssert::create(),
            Zend_Registry::get('logger')->cloneMe('defaultCoordinatorGroupJob.update'),
        );
    }

    public function updateJob(DefaultCoordinatorGroupJob $job, UpdateDefaultJobDto $dto): void
    {
        try {
        ...
        try {
            $this->defaultCoordinatorGroupJobPermissionAssert->assertGranted(
            ...
            $this->logger->info(
                ...
                [
                    'message' => sprintf(
                        'Attempt to update default Coordinator Group job (id: "%s") by AuthUser (guid: %s) was granted',
                        $job->getId(),
            ...
            $this->logger->info(
                ...
                [
                    'message' => sprintf(
                        'Attempt to update default Coordinator Group job (id: "%s") by AuthUser (guid: %s) was denied',
                        $job->getId(),
                        $authUser->getUserGuid(),
                    ),
                    'reason' => $e::class,
