...
class DeleteDefaultCoordinatorGroupJobOperation implements DeleteDefaultCoordinatorGroupJobOperationInterface
{
    public function __construct(
        private readonly ZfExtended_AuthenticationInterface $authentication,
        private readonly UserRepository $userRepository,
        private readonly DeleteDefaultCoordinatorGroupJobOperationInterface $operation,
    ...
    public static function create(): self
    {
        return new self(
            ...
            new UserRepository(),
            \MittagQI\Translate5\DefaultJobAssignment\DefaultCoordinatorGroupJob\Operation\DeleteDefaultCoordinatorGroupJobOperation::create(),
            DefaultCoordinatorGroupJobActionPermissionAssert::create(),
            Zend_Registry::get('logger')->cloneMe('defaultCoordinatorGroupJob.delete'),
        );
    }

    public function delete(DefaultCoordinatorGroupJob $job): void
    {
        try {
        ...
        try {
            ...
            $this->logger->info(
                ...
                [
                    'message' => sprintf(
                        'Attempt to delete default Coordinator Group job by AuthUser (guid: %s) was denied',
                        $authUser->getUserGuid(),
                    ),
                    'customer' => $job->getCustomerId(),
                    'coordinatorGroup' => $job->getGroupId(),
