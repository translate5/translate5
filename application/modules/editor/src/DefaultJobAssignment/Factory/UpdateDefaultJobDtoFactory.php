...
class UpdateDefaultJobDtoFactory
{
     ...
     */
    public function fromRequest(Request $request): UpdateDefaultJobDto
    {
        ...
        return new UpdateDefaultJobDto(
            $user?->getUserGuid(),
            $sourceLanguage ? (int) $sourceLanguage->getId() : null,
            $targetLanguage ? (int) $targetLanguage->getId() : null,
            $data['workflowStepName'] ?? null,
