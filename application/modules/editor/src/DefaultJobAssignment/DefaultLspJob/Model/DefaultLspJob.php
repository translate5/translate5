...
namespace MittagQI\Translate5\DefaultJobAssignment\DefaultLspJob\Model;
 ...
 */
class DefaultLspJob extends ZfExtended_Models_Entity_Abstract
{
    protected $dbInstanceClass = DefaultLspJobTable::class;
}
