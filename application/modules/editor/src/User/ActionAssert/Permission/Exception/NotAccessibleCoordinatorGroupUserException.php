...
final class NotAccessibleCoordinatorGroupUserException extends NoAccessException implements PermissionExceptionInterface, CoordinatorGroupUserExceptionInterface
{
    public function __construct(
        public readonly CoordinatorGroupUser $coordinatorGroupUser
    ) {
        parent::__construct();
    }
}
