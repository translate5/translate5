 ...
 */
class JobRestrictionAssert implements FeasibilityAssertInterface
{
    /**
     * @param ActionFeasibilityAssertInterface<UserJob> $userJobActionFeasibilityAssert
     */
    ...
    public function assertAllowed(object $object): void
    {
        foreach ($this->userJobRepository->getJobsByUserGuid($object->getUserGuid()) as $job) {
            try {
                ...
                throw new UserHasUnDeletableJobException(previous: $e);
            }
        }
    }
}