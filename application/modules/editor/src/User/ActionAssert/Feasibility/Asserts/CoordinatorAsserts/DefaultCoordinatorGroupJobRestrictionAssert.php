 ...
 */
class DefaultCoordinatorGroupJobRestrictionAssert implements FeasibilityAssertInterface
{
    ...
    {
        if ($this->defaultCoordinatorGroupJobRepository->coordinatorAssignedToDefaultCoordinatorGroupJobs($object)) {
            throw new CoordinatorHasAssignedDefaultCoordinatorGroupJobException($object);
        }
    }
}
