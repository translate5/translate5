 ...
 */
class CoordinatorGroupJobRestrictionAssert implements FeasibilityAssertInterface
{
    ...
    {
        if ($this->coordinatorGroupJobRepository->coordinatorAssignedToCoordinatorGroupJobs($object)) {
            throw new CoordinatorHasAssignedCoordinatorGroupJobException($object);
        }
    }
}
