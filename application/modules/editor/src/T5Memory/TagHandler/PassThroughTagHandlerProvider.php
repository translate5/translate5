...
namespace MittagQI\Translate5\T5Memory\TagHandler;

use MittagQI\Translate5\T5Memory\Contract\TagHandlerProviderInterface;
use Zend_Config;

class PassThroughTagHandlerProvider implements TagHandlerProviderInterface
{
    ...
    public function getTagHandler(
        ...
        $tagHandler = new PassThroughHandler([
            'gTagPairing' => false,
            PassThroughHandler::OPTION_KEEP_WHITESPACE_TAGS => $sendWhitespaceAsTag,
        ]);
