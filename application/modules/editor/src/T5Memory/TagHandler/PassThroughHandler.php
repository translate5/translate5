...
class PassThroughHandler extends TagHandler
{
    public function __construct(array $options = [])
    {
        parent::__construct($options);

        $this->xmlparserUnusableTags = new \editor_Models_Import_FileParser_XmlParser();
    }

    protected function processXliffTags(string $queryString): string
    {
        return $this->utilities->internalTag->restore($queryString);
    }
