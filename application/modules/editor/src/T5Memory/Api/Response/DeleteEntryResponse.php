...
class DeleteEntryResponse extends AbstractResponse
{
    ...
    public function successful(): bool
    {
        ...
        return $this->getBody()['fileFlushed'] === 1;
    }

    public function segmentChanged(): bool
    {
        return $this->getErrorMessage() === 'SEGMENT_ID_IS_NOT_EQUAL';
    }

    public function getSegment(): array
    {
        return $this->getBody()['results'][0] ?? [];
    }
}
