...
use MittagQI\Translate5\T5Memory\Api\Response\AbstractResponse;
use Psr\Http\Message\ResponseInterface as PsrResponseInterface;

class CreateTmResponse extends AbstractResponse implements CreateMemoryResponseInterface
{
    public function __construct(
        array $body,
        ?string $errorMessage,
        int $statusCode,
        private readonly string $tmName,
    ) {
    ...
    public static function fromResponse(PsrResponseInterface $response): self
    {
        ...
        if (empty($body['name'])) {
            $errorMsg = 't5memory haven\'t returned a name for the new TM';
        }
