...
class CronEventTrigger
{
    ...
    public function triggerPeriodical(): void
    {
        $this->events->trigger(self::PERIODICAL, self::class);
    }

    public function triggerDaily(): void
    {
        $this->events->trigger(self::DAILY, self::class);
    }
}