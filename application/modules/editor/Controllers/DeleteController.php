...
/**
 */
class Editor_DeleteController extends ZfExtended_Controllers_Action {
    /**
     * löscht einen per URL übergebenen Task komplett aus der Datenbank
     */
