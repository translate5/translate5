...
class Editor_TermportalController extends ZfExtended_Controllers_Action
{
    public function indexAction()
    {
        ...
        $this->view->Php2JsVars()->set('termStatusMap', editor_Models_Terminology_Models_TermModel::getTermStatusMap());
     ...
     * @return array
     */
    private function normalizeLanguage(string $langString): array
    {
