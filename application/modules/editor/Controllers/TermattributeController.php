...
class editor_TermattributeController extends ZfExtended_RestController
{
    ...
    public function confirmproposalOperation()
    {
        ...
        $this->entity->setProcessStatus(editor_Models_Terminology_Models_TermModel::PROCESS_STATUS_PROV_PROCESSED);
    ...
    public function removeproposalOperation()
    {
        ...
        if ($this->view->rows->processStatus == editor_Models_Terminology_Models_TermModel::PROCESS_STATUS_UNPROCESSED) {
            $this->entity->delete();
            $this->view->rows = [];
            return;
        }
