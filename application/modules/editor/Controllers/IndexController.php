...
class Editor_IndexController extends ZfExtended_Controllers_Action
{
    ...
    protected function setJsVarsInView()
    {
        ...
        $this->view->Php2JsVars()->set('import.forbiddenReferenceExtensions', editor_Models_Import_DirectoryParser_ReferenceFiles::FORBIDDEN_EXTENSIONS);
    ...
    public function workercleanupstateAction()
    {
        ...
        if(defined('APPLICATION_APITEST') && $config->runtimeOptions->cronIP === $_SERVER['REMOTE_ADDR']){
            $this->view->workercleanupstate = ZfExtended_Debug::workerCleanupState();
        }
    }
