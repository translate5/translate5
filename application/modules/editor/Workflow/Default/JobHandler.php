...
{
    public const HANDLE_JOB_UNFINISH = 'doUnfinish';

    public const HANDLE_JOB_FIRSTCONFIRMOFASTEP = 'handleFirstConfirmOfAStep';

    public const HANDLE_JOB_FIRSTCONFIRM = 'handleFirstConfirm';

    public const HANDLE_JOB_ALLCONFIRMOFASTEP = 'handleAllConfirmOfAStep';

    public const HANDLE_JOB_ALLCONFIRM = 'handleAllConfirm';

    public const HANDLE_JOB_CONFIRM = 'handleConfirm';

    public const HANDLE_JOB_ADD = 'handleUserAssociationAdded';
    ...
    public function executeSave(editor_Workflow_Actions_Config $actionConfig, callable $saveCallback): ?string
    {
        ...
        $actionConfig->events->trigger($state, $actionConfig->workflow, [
            'oldTua' => $actionConfig->oldTua,
            'newTua' => $actionConfig->newTua,
        ]);
