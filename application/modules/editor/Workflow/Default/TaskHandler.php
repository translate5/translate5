...
{
    public const HANDLE_TASK_CHANGE = 'handleTaskChange';

    public const HANDLE_TASK_REOPEN = 'doReopen';

    public const HANDLE_TASK_CONFIRM = 'doTaskConfirm';

    public const HANDLE_TASK_END = 'doEnd';
    ...
    public function execute(editor_Workflow_Actions_Config $actionConfig): ?string
    {
        ...
        $tasks = [
            'oldTask' => $actionConfig->oldTask,
            'newTask' => $actionConfig->task,
        ];
