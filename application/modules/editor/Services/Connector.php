 ...
 * @method bool update(editor_Models_Segment $segment, bool $recheckOnUpdate = false, bool $rescheduleOnError = false, bool $useSegmentTimestamp = false) editor_Services_Connector_Abstract::update()
