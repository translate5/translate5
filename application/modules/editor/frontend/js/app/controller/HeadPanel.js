...
Ext.define('Editor.controller.HeadPanel', {
  ...
  showUserStateHelpWindow:function(){
	  var provider=Ext.state.Manager.getProvider(),
	      helpWindowState=provider.get(this.getHelpWindowStateId());
  ...
  /***
   * Get helpwindow state id. The state is autogenerated based on whenre the 
   */
  getHelpWindowStateId:function(){
	  var helpWindow=Ext.widget('helpWindow',{});
	  return helpWindow.getStateId();
  }
