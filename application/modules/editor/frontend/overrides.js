...
Ext.override(Ext.window.Window, {
	...
	setDoNotShowAgain:function(value){
		...
		console.log("setDoNotShowAgain",value);
		console.log("setDoNotShowAgain: state",tmpState);
		this.doNotShowAgain=value;
	},
	
	getDoNotShowAgain:function(){
		console.log("getDoNotShowAgain",this.doNotShowAgain);
		var tmpState=this.getState();
		console.log("getDoNotShowAgain: state",tmpState);
		return this.doNotShowAgain;
	},
	
	show:function(){
		var me=this;
		console.log("show -> : ",me,me.doNotShowAgain)
		if(me.doNotShowAgain){
			return false;
		}
