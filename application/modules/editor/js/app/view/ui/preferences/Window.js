...
/**
 * @class Editor.view.ui.preferences.Window
 * @extends Ext.window.Window
 * 
 * Warning: the button to show this window is currently disabled if changealikes are disabled, 
 * since this dialog currently shows only changealike settings!
 */
