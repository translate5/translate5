...
Ext.define('Editor.view.HeadPanel', {
    ...
    infoTpl: [
                  ...
                  '<div class="info-line"><span class="task-label">TaskGuid:</span> <span class="task-name">{task.taskGuid}</span>',
                  '</tpl>',
                  '<tpl if="version">',
                  '<div class="info-line"><span class="task-label">Version:</span> <span class="task-name">{version}</span>',
                  '</tpl>',
                  '<tpl if="isReadonly">',
