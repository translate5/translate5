...
class editor_Models_SegmentFieldManager
{
     ...
     * @var string
     */
    public const _EDIT_SUFFIX = 'Edit';

    /**
     * @var string
     */
    public const _TOSORT_SUFFIX = 'ToSort';
     ...
     * @var array
     */
    protected $segmentDataMap = [];

    /**
     * @var array
     */
    protected $firstNameOfType = [];
    ...
    public function getDataLocationByKey($key)
    {
        if (array_key_exists($key, $this->segmentDataMap)) {
            return array_combine(['field', 'column'], explode(self::_MAP_DELIM, $this->segmentDataMap[$key]));
        }
    ...
    {
        return ZfExtended_Factory::get('editor_Models_Segment_MaterializedView', [$this->taskGuid]);
    }
