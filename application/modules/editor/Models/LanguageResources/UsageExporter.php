...
{
    public const MONTHLY_SUMMARY_BY_RESOURCE = 'MonthlySummaryByResource';

    public const USAGE_LOG_BY_CUSTOMER = 'UsageLogByCustomer';

    public const DOCUMENT_USAGE = 'DocumentUsage';

    public const CHUNKS_BUFFER = 1000000; //number of log entries per excel file
