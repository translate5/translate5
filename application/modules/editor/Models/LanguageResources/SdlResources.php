    ...
    public function mergeEngineData($engines,$addArrayId=true) {
        ...
        foreach($engines as $engine){
            ...
            $data=array(
                ...
                'source' => is_array($engine) ? $engine['sourceLangRfc5646'][0] : $engine->fromCulture,
                'sourceIso' => is_array($engine) ? $lngs[$engine['sourceLang'][0]] : $engine->from->code,
                'target' => is_array($engine) ? $engine['targetLangRfc5646'][0]: $engine->toCulture,
                'targetIso' => is_array($engine) ?$lngs[$engine['targetLang'][0]]:$engine->to->code,
