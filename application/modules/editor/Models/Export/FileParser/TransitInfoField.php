...
{
    public const TARGET_TYPE_EDITED = 'edited';

    public const TARGET_TYPE_ORIGINAL = 'original';
     ...
     * @var array
     */
    protected $sourceGidsStatCount = [];

    /**
     * Counter how often a term with a specific gid is used in target
     * @var array
     */
    protected $targetGidsCount = [];

    /**
     * Maps the source mids to their groupid
     * @var array
     */
    protected $midToGroupMap = [];

    /**
     * Terms of a gid in source
     * @var array
     */
    protected $gidTermsSource = [];

    /**
     * Terms of a gid in source
     * @var array
     */
    protected $gidTermsTarget = [];
    ...
    protected function infoFieldAddTerms()
    {
        ...
        $this->sourceGidsStatCount = [];
        $this->targetGidsCount = [
            self::TARGET_TYPE_EDITED => [],
            self::TARGET_TYPE_ORIGINAL => [],
        ];
