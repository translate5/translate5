...
class editor_Models_Segment_MaterializedView
{
    ...
    protected function checkMvFillState()
    {
        ...
        for ($i = 1; $i < 8; $i++) {
            ...
            $res = $db->fetchRow($fillQuery, [$this->taskGuid, $this->taskGuid]);
    ...
    public function cleanUp()
    {
        ...
        $tasksInUse = $db->fetchAll($sql, [$lifeTime], Zend_Db::FETCH_COLUMN);
        $viewsInUse = array_map([$this, 'makeViewName'], $tasksInUse);
