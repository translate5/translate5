...
{
    public const TAG_INS = editor_Models_Segment_TrackChangeTag::NODE_NAME_INS;

    public const TAG_TERM = 'div';

    public const START_INS = '<' . self::TAG_INS;

    public const END_INS = '</' . self::TAG_INS . '>';

    public const START_TERM = '<' . self::TAG_TERM;

    public const END_TERM = '</' . self::TAG_TERM . '>';
