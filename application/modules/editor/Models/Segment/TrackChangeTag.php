...
class editor_Models_Segment_TrackChangeTag extends editor_Models_Segment_TagAbstract
{
     ...
     * @var string
     */
    public const REGEX_DEL = '/<del[^>]*>.*?<\/del>/i';
     ...
     * @var string
     */
    public const PLACEHOLDER_TAG_DEL = 'segment:del';

    /***
     * delete node name
     */
    public const NODE_NAME_DEL = 'del';

    /***
     * insert node name
     * @var string
     */
    public const NODE_NAME_INS = 'ins';

    /***
     * insert tag css class
     * @var string
     */
    public const CSS_CLASSNAME_INS = 'trackchanges ownttip';

    /***
     * delete tag css class
     * @var string
     */
    public const CSS_CLASSNAME_DEL = 'trackchanges ownttip deleted';

    /***
     * Attributes for the trackchange-Node
     * @var string
     */
    public const ATTRIBUTE_USERTRACKINGID = 'data-usertrackingid';

    public const ATTRIBUTE_USERCSSNR = 'data-usercssnr';

    public const ATTRIBUTE_WORKFLOWSTEP = 'data-workflowstep';

    public const ATTRIBUTE_TIMESTAMP = 'data-timestamp';

    public const ATTRIBUTE_HISTORYLIST = 'data-historylist';

    public const ATTRIBUTE_HISTORY_SUFFIX = '_history_';

    public const ATTRIBUTE_ACTION = 'data-action';

    public const ATTRIBUTE_USERCSSNR_VALUE_PREFIX = 'usernr';
