...
class editor_Models_Converter_SegmentsToXliff2 extends editor_Models_Converter_SegmentsToXliffAbstract
{
     ...
     * @var string
     */
    public const XLIFF2_SEGMENT_STATE_INITIAL = 'initial';

    /***
     * xlif2 segment state
     * @var string
     */
    public const XLIFF2_SEGMENT_STATE_TRANSLATED = 'translated';

    /***
     * xlif2 segment state
     * @var string
     */
    public const XLIFF2_SEGMENT_STATE_REVIEWED = 'reviewed';

    /***
     * xlif2 segment state
     * @var string
     */
    public const XLIFF2_SEGMENT_STATE_FINAL = 'final';

    /**
     * addQm              = boolean, add segment QM, defaults to true
     * @var string
     */
    public const CONFIG_ADD_QM = 'addQm';

    /***
     * Segment id xliff prefix
     * @var string
     */
    public const SEGMENT_ID_PREFIX = "seg";

    /***
     * Unit id xliff prefix
     * @var string
     */
    public const UNIT_ID_PREFIX = "unit";

    /***
     * Qm id xliff prefix
     * @var string
     */
    public const QM_ID_PREFIX = "QM_";
    ...
    protected function initConvertionData()
    {
        ...
        foreach ($taskUserTrackingData as $value) {
            $this->trackingData[$value['id']] = (object) [
    ...
    protected function initItsPersonGuid($segment)
    {
        ...
        if ($isTranslatorSet && count($assocUsers[editor_Workflow_Default::ROLE_TRANSLATOR]) == 1) {
        ...
        } elseif (! $isTranslatorSet || count($assocUsers[editor_Workflow_Default::ROLE_TRANSLATOR]) == 0) {//if the there is no translator, check for translatorCheck
            ...
            } elseif (count($assocUsers[editor_Workflow_Default::ROLE_TRANSLATORCHECK]) > 1) {//more than one tanslator check
