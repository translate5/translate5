...
class editor_Models_Converter_SegmentsToXliff extends editor_Models_Converter_SegmentsToXliffAbstract
{
     ...
     * @var string
     */
    public const CONFIG_INCLUDE_DIFF = 'includeDiff';
