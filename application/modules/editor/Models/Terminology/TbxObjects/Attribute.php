...
{
    public const ATTRIBUTE_LEVEL_ENTRY = 'entry';

    public const ATTRIBUTE_LEVEL_LANGUAGE = 'language';

    public const ATTRIBUTE_LEVEL_TERM = 'term';

    public const ATTRIBUTE_DEFAULT_DATATYPE = 'plainText';
