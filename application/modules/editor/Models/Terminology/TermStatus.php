...
{
    public const DEFAULT_TAG = 'termNote';

    public const DEFAULT_TYPE_ADMINISTRATIVE_STATUS = 'administrativeStatus';

    public const DEFAULT_TYPE_NORMATIVE_AUTHORIZATION = 'normativeAuthorization';
     ...
     */
    protected static array $termStatusMap;
