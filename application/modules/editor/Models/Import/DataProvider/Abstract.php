...
abstract class editor_Models_Import_DataProvider_Abstract
{
     ...
     */
    public const IMPORT_UPLOAD_LANGUAGES_NAME = 'importUpload_language';

    /***
     * Task type field name in the request when the project upload is used
     */
    public const IMPORT_UPLOAD_TYPE_NAME = 'importUpload_type';

    public const TASK_ARCHIV_ZIP_NAME = 'ImportArchiv.zip';

    public const TASK_TEMP_IMPORT = '_tempImport';
     ...
     * @return string
     */
    final protected function getZipArchivePath($filename = null)
    {
        if (empty($filename)) {
