...
class editor_Models_Import_FileParser_Xlf extends editor_Models_Import_FileParser
{
    ...
    protected function parse()
    {
        ...
        try {
            $this->_origFile = $this->namespaces->preProcessFile($this->_origFile);
    ...
    protected function checkXliffVersion($attributes, $key)
    {
        ...
        if (! in_array($version, $validVersions)) {
            // Only XLF 1.1 and 1.2 are natively supported. You can use OKAPI to import XLIFF Version 2 files. The imported xliff tag: {tag}
