...
class editor_Models_Term extends ZfExtended_Models_Entity_Abstract {
     ...
     */
    public function getTermAndGroupIdToMid(string $mid, array $collectionIds): ?array
    {
     ...
     * @return array
     */
    public function searchTermByLanguage(string $queryString, array $languages, array $collectionIds, $limit = null, array $processStats): array
    {
...
//    }
     ...
     * @return array
     */
    static public function getAllTransStatus(): array
    {
        self::initConstStatus();
     ...
     * @return boolean
     */
    static public function isPreferredTerm($termstatus): bool
    {
