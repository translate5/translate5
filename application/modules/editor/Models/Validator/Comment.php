...
class editor_Models_Validator_Comment extends ZfExtended_Models_Validator_Abstract
{
    /**
     * Validators for Comment Entity
    ...
    protected function defineValidators()
    {
        ...
        $this->addDontValidateField('comment');
        ...
        $this->addValidator('created', 'date', ['Y-m-d H:i:s']);
        $this->addValidator('modified', 'date', ['Y-m-d H:i:s']);
    }
}
