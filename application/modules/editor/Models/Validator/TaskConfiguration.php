...
class editor_Models_Validator_TaskConfiguration extends ZfExtended_Models_Validator_Abstract
{
    /**
     * Validators for TaskConfiguration entity
     */
    protected function defineValidators()
    {
        ...
        $this->addValidator('taskGuid', 'stringLength', [
            'min' => 0,
            'max' => 38,
        ]);
        ...
        $this->addValidator('defaults', 'stringLength', [
            'min' => 0,
            'max' => 1024,
        ]);
        //`type` enum('string','integer','float','boolean','list','map','absolutepath','markup','json','regex','regexlist','xpath','xpathlist') NOT NULL DEFAULT 'string',
