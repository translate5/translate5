...
class editor_Models_Validator_Term_Attribute extends ZfExtended_Models_Validator_Abstract
{
    ...
    protected function defineValidators()
    {
        ...
        // termEntryId ?
        $this->addValidator('language', 'stringLength', [
            'min' => 0,
            'max' => 45,
        ]);
        $this->addValidator('termId', 'int');
        $this->addValidator('termTbxId', 'stringLength', [
            'min' => 0,
            'max' => 100,
        ]);
        $this->addValidator('dataTypeId', 'int');
        $this->addValidator('type', 'stringLength', [
            'min' => 0,
            'max' => 100,
        ]);
        ...
        $this->addValidator('target', 'stringLength', [
            'min' => 0,
            'max' => 100,
        ]);
        ...
        // updatedAt ?
        $this->addValidator('termEntryGuid', 'stringLength', [
            'min' => 0,
            'max' => 38,
        ]);
        $this->addValidator('langSetGuid', 'stringLength', [
            'min' => 0,
            'max' => 38,
        ]);
        // termGuid ?
        $this->addValidator('guid', 'stringLength', [
            'min' => 0,
            'max' => 38,
        ]);
        $this->addValidator('elementName', 'stringLength', [
            'min' => 0,
            'max' => 100,
        ]);
        // attrLang ?
        ...
        $this->addValidator('entryId', 'stringLength', [
            'min' => 0,
            'max' => 100,
        ]); // no such column
