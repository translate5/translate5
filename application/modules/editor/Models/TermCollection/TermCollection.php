...
class editor_Models_TermCollection_TermCollection extends editor_Models_LanguageResources_LanguageResource
{
    ...
    public function getTermTranslationsForLanguageCombo(int $collection, int $source, int $target): array
    {
        ...
        // Deprecated terms are not selected for target language.
        // The terms with preferredTerm status will have always priority against the other terms.
        // In case the term is not in preferredTerm status, the next most valuable status is admittedTerm.
        ...
        // term status order by and termEntryId group by, only one target term returned for each source.
