 ...
 *
 * @method editor_Segment_TagRepair_Tag clone(bool $withDataAttribs=false, bool $withId=false)
 * @method editor_Segment_TagRepair_Tag cloneProps(editor_Tag $tag, bool $withDataAttribs=false, bool $withId=false)
 * @property editor_Segment_TagRepair_Tag|editor_TextNode[] $children
 */
class editor_Segment_TagRepair_Tag extends editor_Segment_Tag {
    ...
    protected function createBaseClone(){
        return new editor_Segment_TagRepair_Tag($this->startIndex, $this->endIndex, $this->category, $this->name);
    }
    /**
     ...
     */
    public function capturePosition(editor_Segment_TagRepair_Tags $tags, int $textLength){
        $this->numWords = 0;
     ...
     * @return int
     */
    public function getNumWords(editor_Segment_TagRepair_Tags $tags) : int {
        if($this->isSingular()){
            return 0;
        }
     ...
     */
    public function reEvaluateTagPosition(editor_Segment_TagRepair_Tags $tags, int $textLength,  float $wordRatio, float $textRatio){
     ...
     * @param float $textRatio: the ratio of the number of characters
     */
    public function reEvaluateSingularTagPosition(editor_Segment_TagRepair_Tags $tags, int $textLength, float $wordRatio, float $textRatio){
         if($this->startIndex < 0){
