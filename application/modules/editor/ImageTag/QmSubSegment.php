...
{
    public const IMAGE_PADDING_WIDTH = 15;

    public const IMAGE_PADDING_HEIGHT = 4;

    public const TEXT_PADDING_RIGHT = 5;
    ...
    public function __construct()
    {
        ...
        $this->_tagDef = new Zend_Config([], 1);
