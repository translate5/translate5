...
VALUES ('runtimeOptions.import.xlf.placeablesXpathes', '1', 'editor', 'import', '[]', '[]', '', 'xpathlist', 'A list of XPaths that will search regular internal tags if they contain placeables. Placeables will always be shown with their text-content and not as traditional internal tags.', 8, 'XLF Import placebles: Detection XPaths', 'File parser options', '');
