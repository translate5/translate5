...
('2025-09-02', 'TRANSLATE-4932', 'bugfix', 'User Management - StarMiele-Plugin: correct Plunet status-calculation for task', '[🐞 Fix] Set TUA-state "edit" equal to "open" for calculation, so state will be calculated correct as "in Arbeit"', '15'),
