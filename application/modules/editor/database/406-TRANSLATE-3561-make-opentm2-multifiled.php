...
$SCRIPT_IDENTIFIER = '406-TRANSLATE-3561-make-opentm2-multifiled.php';

$db = Zend_Db_Table::getDefaultAdapter();
$languageresources = $db
    ->query("SELECT id, specificData FROM LEK_languageresources WHERE serviceName = 'OpenTM2'")
    ->fetchAll();

foreach ($languageresources as $languageresource) {
    $specificData = json_decode($languageresource['specificData'], true);
    $specificData['memories'] = [
        [
