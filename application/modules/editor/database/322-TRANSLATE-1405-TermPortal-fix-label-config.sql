...
CREATE TABLE `terms_term_status_map` (
    ...
    `mappedStatus` enum('supersededTerm', 'preferredTerm', 'admittedTerm', 'deprecatedTerm', 'standardizedTerm', 'legalTerm', 'regulatedTerm'),
PRIMARY KEY (`id`),
...
('normativeAuthorization', 'standardizedTerm', 'standardizedTerm'),
('normativeAuthorization', 'regulatedTerm', 'regulatedTerm'),
('normativeAuthorization', 'legalTerm', 'legalTerm'),
('normativeAuthorization', 'deprecatedTerm', 'deprecatedTerm'),
('normativeAuthorization', 'supersededTerm', 'supersededTerm'),
...
('administrativeStatus', 'standardizedTerm-admn-sts', 'standardizedTerm'),
('administrativeStatus', 'regulatedTerm-admn-sts', 'regulatedTerm'),
('administrativeStatus', 'legalTerm-admn-sts', 'legalTerm'),
('administrativeStatus', 'deprecatedTerm-admn-sts', 'deprecatedTerm'),
('administrativeStatus', 'supersededTerm-admn-sts', 'supersededTerm'),
