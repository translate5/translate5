...
('runtimeOptions.autoQA.enableSegmentNumbersCheck', 1, 'editor', 'system', 1, 1, '', 'boolean', 'If activated (default), AutoQA covers checking the segments against numbers checks, provided by SNC-lib', 8, 'Enables segment numbers checks', 'Editor: QA', '');
