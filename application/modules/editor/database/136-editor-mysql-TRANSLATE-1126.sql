...
VALUES
 ('runtimeOptions.worker.editor_Models_Export_Xliff2Worker.maxParallelWorkers', 1, 'editor', 'worker', 3, 3, '', 'integer', 'Max parallel running workers of the xliff2 export worker.');
