...
/(\s|^|\()([±\-+]?((([1-9]\d{0,2}\.){1}(\d{3}\.)*\d{3})|([1-9]\d{0,2}))'\d+)(([\.,;:?!](\s|$))|\s|$|\))/u
REGEX,
...
/(\s|^|\()([±\-+]?(((\d{1,4},){1}(\d{4},)*\d{4})|([1-9]\d{0,3}))\.\d+)(([\.,;:?!](\s|$))|\s|$|\))/u
REGEX,
...
/(\s|^|\()([±\-+]?((([1-9]\d{0,2}\x{2009}){1}(\d{3}\x{2009})*\d{3})|([1-9]\d{0,2}))\.\d+)(([\.,;:?!](\s|$))|\s|$|\))/u
REGEX,
    'default with [NNBSP] thousand decimal dot' => <<<REGEX
/(\s|^|\()([±\-+]?((([1-9]\d{0,2}\x{202F}){1}(\d{3}\x{202F})*\d{3})|([1-9]\d{0,2}))\.\d+)(([\.,;:?!](\s|$))|\s|$|\))/u
REGEX,
