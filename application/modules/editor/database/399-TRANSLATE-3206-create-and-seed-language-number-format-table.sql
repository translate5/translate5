...
('float', '/\\b([١٢٣٤٥٦٧٨٩]{1,3}٬){1}(\\d{3}٬)*\\d{3}٫\\d+\\b/u', '#٬##0٫###', false, 217),

('float', "/\\b([1-9]\\d{0,2}\\.){1}(\\d{3}\\.)*\\d{3}'\\d+\\b/u", "#.##0'###", false, 216),
('float', '/\\b(\\d,)?(\\d{2},)+(\\d{3})\\.\\d+\\b/u', '#,##,##0.###', false, 215),

('float', '/\\b([1-9]\\d{0,2},){1}(\\d{3},)*\\d{3}\\.\\d+\\b/u', '#,##0.###', false, 214),
('float', '/\\b(\\d{1,4},){1}(\\d{4},)*\\d{4}\\.\\d+\\b/u', '#,###0.###', false, 213),
('float', '/\\b([1-9]\\d{0,2},){1}(\\d{3},)*\\d{3}·\\d+\\b/u', '#,##0·###', false, 212),
('float', '/\\b([1-9]\\d{0,2} ){1}(\\d{3} )*\\d{3}\\.\\d+\\b/u', '# ##0.###', false, 211),
('float', '/\\b([1-9]\\d{0,2}\\x{2009}){1}(\\d{3}\\x{2009})*\\d{3}\\.\\d+\\b/u', '# ##0.###', false, 210),
('float', '/\\b([1-9]\\d{0,2}\\x{202F}){1}(\\d{3}\\x{202F})*\\d{3}\\.\\d+\\b/u', '# ##0.###', false, 209),
('float', '/\\b([1-9]\\d{0,2}˙){1}(\\d{3}˙)*\\d{3}\\.\\d+\\b/u', '#˙##0.###', false, 208),
('float', "/\\b([1-9]\\d{0,2}'){1}(\\d{3}')*\\d{3}\\.\\d+\\b/u", "#'##0.###", false, 207),

('float', '/\\b([1-9]\\d{0,2}\\.){1}(\\d{3}\\.)*\\d{3},\\d+\\b/u', '#.##0,###', false, 206),
('float', '/\\b([1-9]\\d{0,2} ){1}(\\d{3} )*\\d{3},\\d+\\b/u', '# ##0,###', false, 205),
('float', '/\\b([1-9]\\d{0,2}\\x{2009}){1}(\\d{3}\\x{2009})*\\d{3},\\d+\\b/u', '# ##0,###', false, 204),
('float', '/\\b([1-9]\\d{0,2}\\x{202F}){1}(\\d{3}\\x{202F})*\\d{3},\\d+\\b/u', '# ##0,###', false, 203),
('float', '/\\b([1-9]\\d{0,2}˙){1}(\\d{3}˙)*\\d{3},\\d+\\b/u', '#˙##0,###', false, 202),
('float', "/\\b([1-9]\\d{0,2}'){1}(\\d{3}')*\\d{3},\\d+\\b/u", "#'##0,###", false, 201),
('float', '/\\b([1-9]|[1-9]\\d+)(\\.|,|·)\\d+\\b/u', null, false, 197),

-- integer
('integer', "/\\b[1-9]\\d{0,3}(,)?(\\d{4}\\1)+\\d{4}\\b/u", '#,###0', false, 200),
('integer', "/\\b[1-9]\\d{0,2}(,|\\.|·|˙|'|\\x{2009}|\\x{202F}|٬)?(\\d{3}\\1)+\\d{3}\\b/u", null, false, 199),
('integer', "/\\b[1-9]\\d{0,1}(,)?(\\d{2}\\1)+\\d{3}\\b/u", '#,##,##0', false, 198),
('integer', "/\\b[١٢٣٤٥٦٧٨٩]{0,2}٬?(\\d{3}٬)*\\d{3}\\b/u", null, false, 101),
('integer', '/\\b(\\d|[1-9]\\d+)\\b/u', '#', false, 100)
;
