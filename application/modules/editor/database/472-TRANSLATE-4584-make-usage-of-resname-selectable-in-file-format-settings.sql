...
VALUES ('runtimeOptions.import.xlf.skipResnamesForExtensions', '1', 'editor', 'import', 'xls,xlsx,ods', 'xls,xlsx,ods', '', 'string', 'Comma separated file extensions not to use resnames for', 8, 'XLIFF Parsing: No resnames usage', 'File formats', '');
