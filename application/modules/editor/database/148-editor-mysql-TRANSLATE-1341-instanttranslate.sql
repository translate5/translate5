...
INSERT INTO `Zf_configuration` (`name`, `confirmed`, `module`, `category`, `value`, `default`, `defaults`, `type`, `description`) 
VALUES ('runtimeOptions.LanguageResources.searchCharacterLimit', '1', 'editor', 'instanttranslate', '[]', '[]', '', 'map', 'Maximum character per language resource allowed for search. The configuration key is the language resource id, and the value is the character limit. Ex: {{\"1\": 100},{\"2\": 300}}');

INSERT INTO `Zf_configuration` (`name`, `confirmed`, `module`, `category`, `value`, `default`, `defaults`, `type`, `description`) 
VALUES ('runtimeOptions.InstantTranslate.minMatchRateBorder', '1', 'editor', 'instanttranslate', '', 50, '', 'integer', 'Minimum matchrate allowed to be displayed in InstantTranslate result list for TM language resources');
