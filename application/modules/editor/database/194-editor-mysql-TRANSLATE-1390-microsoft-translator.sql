...
INSERT INTO `Zf_configuration` (`name`, `confirmed`, `module`, `category`, `value`, `default`, `defaults`, `type`, `description`) VALUES ('runtimeOptions.LanguageResources.microsoft.matchrate', '1', 'editor', 'editor', '', '70', '', 'integer', 'Microsoft translator penalty value, used as default matchrate since in MT no matchrate is available');
