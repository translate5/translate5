...
`guiName` = 'Term process status for usage in the editor and InstantTranslate', 
`guiGroup` = 'Terminology' 
WHERE (`name` = 'runtimeOptions.termTagger.usedTermProcessStatus');
