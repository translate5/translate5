...
('2020-06-04', 'TRANSLATE-1944', 'feature', 'VisualReview: visual live translation (wysiwyg)', 'Enable wysiwyg (what you see is what you get) live translation based on visualReview. For installation and configuration see the according sections in the sub-pages of https://confluence.translate5.net/display/visualReview/visualReview also see the new font administration in the administration section of the application.', '14'),
