...
CREATE TABLE `LEK_user_assoc_default` (
    ...
    `workflowStepName` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'reviewing',
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY `unique_default_user_assoc` (`customerId`,`sourceLang`,`targetLang`,`userGuid`,`workflow`),
