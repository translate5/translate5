var ComponentEditor={
    ...
    isCommmentAttributeRequirementMet: function() {
    	var activeTerm=Term.findActiveTermHeader(),
    		isProposal=activeTerm && activeTerm.hasClass('is-proposal');
        // If the comment attribute mandatory flag is set, check if there is unclosed comment editor.
        if (isProposal && Editor.data.apps.termportal.commentAttributeMandatory && this.isCommentComponentEditorActive()) {
