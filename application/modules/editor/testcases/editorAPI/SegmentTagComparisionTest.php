...
class SegmentTagComparisionTest extends \ZfExtended_Test_Testcase {
    ...
    public function testInternalTags1(){
        ...
        $this->createDataTest($segmentId, $markup, $compareState);
    }
    ...
    public function testRealDataComparision1(){
        ...
        $this->createDataComparisionTest($source, $targetOriginal, ['internal_tag_structure_faulty', 'internal_tags_missing']);
        $this->createDataComparisionTest($source, $targetEdited, ['internal_tags_missing']);
        $this->createDataComparisionTest($targetOriginal, $targetEdited, ['internal_tags_missing']);
    }
    /**
     ...
     * @param string $markup
     */
    private function createDataTest($segmentId, $markup, $compareState){
     ...
     * @param array|string $expectedState
     */
    private function createDataComparisionTest($original, $edited, $expectedState){
