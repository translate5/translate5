 ...
 */
class AxelTest extends \ZfExtended_Test_Testcase {
    
    public static function setUpBeforeClass(): void {
        // TODO: Why is that neccessary ???
        require_once 'Tag.php';
        require_once 'TextNode.php';
        require_once 'Segment/Tag.php';
        require_once 'Segment/AnyTag.php';
        require_once 'Segment/Tags.php';
        require_once 'Segment/FieldTags.php';
        require_once 'Segment/TagCreator.php';
        require_once 'Segment/TagProviderInterface.php';
        require_once 'Segment/Internal/Tag.php';
        require_once 'Segment/Quality/Manager.php';
        require_once 'Segment/Quality/Provider.php';
        require_once 'Segment/TrackChanges/DeleteTag.php';
        require_once 'Segment/TrackChanges/InsertTag.php';
