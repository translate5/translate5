 ...
 */
class BatchWorkerWithMixedSublangTranslate5036Test extends JsonTestAbstract
{
    ...
    protected static array $requiredRuntimeOptions = [
        ...
        'runtimeOptions.LanguageResources.Pretranslation.enableBatchQuery' => 1,
    ];
    ...
    protected static function setupImport(Config $config): void
    {
        ...
        $config
            ->addLanguageResource('deepl', null, $customerId, $sourceLangRfc, 'en-GB');
        $config
            ->addPretranslation()
            ->setProperty('pretranslateMt', 1);
        $config
            ->addTask($sourceLangRfc, 'en-US', $customerId)
    ...
    public function testPivotAutoPretranslation()
    {
        ...
        foreach ($segments as $segment) {
            static::assertNotEmpty($segment->target, 'The pivot field for the segment is empty');
        }
    }
}
