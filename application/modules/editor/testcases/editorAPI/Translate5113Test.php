...
/**
 * Testcase for TRANSLATE-5113
 */
class Translate5113Test extends JsonTestAbstract
{
    ...
    protected static function setupImport(Config $config): void
    {
        ...
        $config
            ->addTask('de-DE', 'en-GB', $customerId, "testfiles/$testName.csv")
    ...
    {
        $jsonFileName = static::class . '.json';
