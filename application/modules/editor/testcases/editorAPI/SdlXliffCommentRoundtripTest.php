...
/**
 * SdlXliffCommentRoundtripTest imports a SDLXLIFF file with comments, adds new comments and export the file again
 */
class SdlXliffCommentRoundtripTest extends \ZfExtended_Test_ApiTestcase {
    public static function setUpBeforeClass(): void {
        ...
        $api->addImportFile($api->getFile('commented-en-de.sdlxliff'));
        $api->import($task);
    ...
    public function testImportedContent() {
        ...
        //file_put_contents("/home/tlauria/www/translate5-master/application/modules/editor/testcases/editorAPI/SdlXliffCommentRoundtripTest/expectedSegments-new.json", json_encode($segments,JSON_PRETTY_PRINT));
        ...
        //file_put_contents("/home/tlauria/www/translate5-master/application/modules/editor/testcases/editorAPI/SdlXliffCommentRoundtripTest/expectedComments-new.json", json_encode($comments,JSON_PRETTY_PRINT));
    ...
    public function testAddNewComments() {
        ...
        //file_put_contents("/home/tlauria/www/translate5-master/application/modules/editor/testcases/editorAPI/SdlXliffCommentRoundtripTest/expectedSegmentsAfterAdd-new.json", json_encode($segments,JSON_PRETTY_PRINT));
        ...
        //file_put_contents("/home/tlauria/www/translate5-master/application/modules/editor/testcases/editorAPI/SdlXliffCommentRoundtripTest/expectedCommentsAfterAdd-new.json", json_encode($comments,JSON_PRETTY_PRINT));
