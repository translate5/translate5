...
class TbxImportApiTest extends \editor_Test_ApiTest {
    ...
    public function testTbxImport(){
        ...
        $termCollection = static::api()->postJson('editor/termcollection', ['name' => 'Test api collection', 'customerIds' => static::getTestCustomerId()]);
    ...
    private function singleTest(int $collectionId, string $fileName,int $termCount,int $termsAtributeCount,int $termsEntryAtributeCount,int $languageAtributeCount){
        ...
        static::api()->postJson('editor/termcollection/import', array('collectionId' => $collectionId, 'customerIds' => static::getTestCustomerId(),'mergeTerms'=>true));
