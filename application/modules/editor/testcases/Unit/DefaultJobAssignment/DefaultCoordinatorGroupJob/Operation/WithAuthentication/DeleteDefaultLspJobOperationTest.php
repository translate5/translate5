...
use MittagQI\Translate5\DefaultJobAssignment\DefaultCoordinatorGroupJob\Operation\WithAuthentication\DeleteDefaultCoordinatorGroupJobOperation;
...
class DeleteDefaultLspJobOperationTest extends TestCase
{
    ...
    private MockObject|DeleteDefaultCoordinatorGroupJobOperationInterface $deleteOperation;
    ...
    private DeleteDefaultCoordinatorGroupJobOperation $operation;

    public function setUp(): void
    {
        $this->authentication = $this->createMock(ZfExtended_AuthenticationInterface::class);
        $this->userRepository = $this->createMock(UserRepository::class);
        $this->deleteOperation = $this->createMock(DeleteDefaultCoordinatorGroupJobOperationInterface::class);
        ...
        $this->operation = new DeleteDefaultCoordinatorGroupJobOperation(
            $this->authentication,
            $this->userRepository,
    ...
    {
        $defaultLspJob = $this->createMock(DefaultCoordinatorGroupJob::class);
