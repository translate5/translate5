...
namespace MittagQI\Translate5\Test\Unit\DefaultJobAssignment\DefaultCoordinatorGroupJob\Operation\DTO;
...
class NewDefaultLspJobTest extends TestCase
{
    public function testZeroAsSourceLanguageIdThrowsError(): void
    {
        ...
        new NewDefaultCoordinatorGroupJobDto(
            1,
    ...
    public function testFromDefaultJobDto(): void
    {
        ...
        $newDefaultLspJobDto = NewDefaultCoordinatorGroupJobDto::fromDefaultJobDto($defaultJobDto);
