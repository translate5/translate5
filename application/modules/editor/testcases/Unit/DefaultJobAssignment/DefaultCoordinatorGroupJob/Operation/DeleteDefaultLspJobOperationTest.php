...
{
    private MockObject|DefaultCoordinatorGroupJobRepository $defaultLspJobRepository;
    ...
    {
        $this->defaultLspJobRepository = $this->createMock(DefaultCoordinatorGroupJobRepository::class);
