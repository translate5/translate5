...
class UpdateDefaultLspJobOperationTest extends TestCase
{
    ...
    private MockObject|UpdateDefaultCoordinatorGroupJobOperationInterface $updateOperation;
    ...
    public function setUp(): void
    {
        ...
        $this->updateOperation = $this->createMock(UpdateDefaultCoordinatorGroupJobOperationInterface::class);
