...
class SegmentTagsTest extends SegmentTagsTestAbstract
{
    ...
    public function testTrackChangesTags1(): void
    {
        ...
        // the same markup but TrackChanges merged to a single tag
        ...
        $textNoTrackChanges = 'L’organisation nationale (réseau de distribution) agit de façon à ce que, dans le cadre de la philosophie Neuroth et des normes du groupe, le plus de personnes possible deviennent et restent des clientes et clients actifs et heureux grâce à ses produits et services de qualité supérieure.';
        $this->createTrackChangesTest($segmentId, $markup, $textNoTrackChanges);
        $this->createTrackChangesTest($segmentId, $markup2, $textNoTrackChanges);
    }
}
