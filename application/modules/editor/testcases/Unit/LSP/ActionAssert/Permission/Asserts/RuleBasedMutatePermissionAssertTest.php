...
class RuleBasedMutatePermissionAssertTest extends TestCase
{
    ...
    {
        $assert = new RuleBasedMutatePermissionAssert(
    ...
    public function testAssertNotGrantedIfNotAdminOrPmAndNotCoordinator(): void
    {
        ...
        $assert = new RuleBasedMutatePermissionAssert($jsRepo);
        $assert->assertGranted($lsp, $context);
    }

    public function testAssertNotGrantedToLspOfCoordinator(): void
    {
        $lsp = $this->createMock(LanguageServiceProvider::class);
