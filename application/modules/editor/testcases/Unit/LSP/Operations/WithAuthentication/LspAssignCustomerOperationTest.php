...
namespace MittagQI\Translate5\Test\Unit\LSP\Operations\WithAuthentication;
...
{
    private LspAssignCustomerOperationInterface|MockObject $generalOperation;
    ...
    {
        $this->generalOperation = $this->createMock(LspAssignCustomerOperationInterface::class);
    ...
    public function testAssignCustomer(): void
    {
        ...
        $this->generalOperation->expects(self::once())->method('assignCustomer')->with($lsp, $customer);
