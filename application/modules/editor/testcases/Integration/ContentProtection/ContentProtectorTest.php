...
class ContentProtectorTest extends UnitTestAbstract
{
    ...
    public function casesProvider(): iterable
    {
        yield 'whitespace right after number' => [
            ...
            'expected' => 'string <number type="float" name="default with comma thousand decimal dot" source="123,456.789" iso="123456.789" target="123.456,789" regex="09eIKa6Jq4nR0NSIPrQxRlc71l5DQyPaUNcyNial2kDHqFZHs9qwVgPIMQYytcC0Zg2KCk3NGL2YFG1NoL4YPR1rK3vFWJCpKpqaNSCqJkZTU78UAA==" key="aaa"/><char ts="c2a0" length="1"/>mm',
        ...
        yield '&lt; in text' => [
            ...
            'expected' => 'string &lt; <number type="float" name="default with comma thousand decimal dot" source="123,456.789" iso="123456.789" target="123.456,789" regex="09eIKa6Jq4nR0NSIPrQxRlc71l5DQyPaUNcyNial2kDHqFZHs9qwVgPIMQYytcC0Zg2KCk3NGL2YFG1NoL4YPR1rK3vFWJCpKpqaNSCqJkZTU78UAA==" key="aaa"/>',
            'entityHandling' => EntityHandlingMode::Off,
        ];
    }
