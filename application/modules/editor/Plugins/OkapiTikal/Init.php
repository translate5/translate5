 ...
 */
class editor_Plugins_OkapiTikal_Init extends ZfExtended_Plugin_Abstract {
    ...
    public function handleBeforeImport(Zend_EventManager_Event $event) {
        ...
        foreach($params['filelist'] as $fileId => $relName) {
            $fileFilter->addFilter($fileFilter::TYPE_IMPORT, $params['task'], $fileId, 'editor_Plugins_OkapiTikal_Filter');
        }
    }
}