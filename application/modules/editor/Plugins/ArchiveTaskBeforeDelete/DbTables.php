...
class editor_Plugins_ArchiveTaskBeforeDelete_DbTables
{
    ...
    protected $tables = [
        ...
        'LEK_languageresources_taskpivotassoc' => false,
        ...
        'LEK_statistics_postediting_aggregation' => 'taskGuid',
        'LEK_statistics_segment_aggregation' => 'taskGuid',
        'LEK_segment_statistics' => 'taskGuid',
        ...
        'LEK_task_workflow_log' => 'taskGuid',
        'LEK_terms' => false,
        ...
        'LEK_visualreview_segmenttimecodes' => 'taskGuid',
