...
class editor_Plugins_ArchiveTaskBeforeDelete_Bootstrap extends ZfExtended_Plugin_Abstract
{
    ...
    {
        $this->eventManager->attach('editor_TaskController', 'beforeDeleteAction', [$this, 'handleBeforeDeleteAction']);
    }
    ...
    public function handleBeforeDeleteAction(Zend_EventManager_Event $event)
    {
        ...
        if (! $archive->createFor($taskGuid)) {
            ZfExtended_Models_Entity_Conflict::addCodes([
                'E1049' => 'Task could not be locked for archiving, stopping therefore the delete call.',
            ]);

            throw new ZfExtended_Models_Entity_Conflict('E1049', [
                'task' => $task,
            ]);
        }
    }
