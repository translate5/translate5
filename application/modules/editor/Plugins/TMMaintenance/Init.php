...
class editor_Plugins_TMMaintenance_Init extends ZfExtended_Plugin_Abstract
{
    ...
    protected function initRoutes(): void
    {
        ...
        $route = new ZfExtended_Controller_RestLikeRoute('editor/plugins_tmmaintenance_api/delete-batch/*', [
            'module' => 'editor',
        ...
        $route = new ZfExtended_Controller_RestLikeRoute('editor/plugins_tmmaintenance_api/delete-similar/*', [
            'module' => 'editor',
            'controller' => 'plugins_tmmaintenance_api',
            'action' => 'deleteSimilar',
        ]);
        $router->addRoute('plugins_tmmaintenance_delete_similar', $route);
