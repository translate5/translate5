...
SET `description` = 'Ip address to customer number map. Example where the users coming from 192.168.2.143 are assigned to customer with number 1000 :{"192.168.2.143" : "1000"} . If no ip to customer map is defined, the default customer will be assigned to the ip authenticated users'
