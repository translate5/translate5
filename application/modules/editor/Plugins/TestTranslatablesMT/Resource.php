...
class editor_Plugins_TestTranslatablesMT_Resource extends editor_Models_LanguageResources_Resource
{
    protected array $supportedSourceLangs;

    protected array $supportedTargetLangs;
