...
abstract class editor_Plugins_Okapi_Bconf_Parser_Bconf {
    ...
    /**
     * @var editor_Plugins_Okapi_Bconf_RandomAccessFile|null
     */
    ...
    /**
     * @var editor_Plugins_Okapi_Bconf_Parser_ExtensionMapping
     */
    ...
    public function process($bconfPath): void {
        ...
        try {
            // DEBUG
            if($this->doDebug){ error_log('UNPACK BCONF: '.$this->bconfName); }
     ...
     * @return editor_Plugins_Okapi_Bconf_Parser_ExtensionMapping
     */
