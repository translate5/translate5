...
Ext.define('Editor.plugins.Okapi.view.BconfFilterGrid', {
    ...
    strings: {
        title: '#UT#Filters of',
        configuration: '#UT#Configure filter',
        showDefaultFilters: '#UT#Show default filters',
        hideDefaultFilters: '#UT#Hide default filters',
        editTexts: '#UT#Edit filter names, associated file extensions, MIME type and description',
        editTextsRowTip: '#UT#Double-click to edit',
        clone: '#UT#Clone filter',
        download: '#UT#Download filter/FPRM as file',
        refresh: '#UT#Refresh',
        remove: '#UT#Delete',
        emptySearch: '#UT#Search for filter',
        ...
        upload: '#UT#Upload filter/FPRM from file',
