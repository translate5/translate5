...
WHERE `worker` = 'editor_Plugins_TermTagger_Worker_TermTaggerImport' AND `dependency` = 'editor_Plugins_Okapi_Worker';

INSERT INTO `Zf_worker_dependencies` (`worker`,`dependency`) VALUES
    ('editor_Segment_Quality_ImportWorker', 'editor_Plugins_Okapi_Worker');
