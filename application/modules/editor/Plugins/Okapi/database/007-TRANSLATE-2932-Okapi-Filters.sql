...
ALTER TABLE `LEK_okapi_bconf_filter` DROP COLUMN `extensions`;

DROP TABLE IF EXISTS `LEK_okapi_bconf_default_filter`;

INSERT IGNORE INTO `Zf_acl_rules` (`module`, `role`, `resource`, `right`) VALUES ('editor', 'pm', 'editor_plugins_okapi_bconfdefaultfilter', 'all');