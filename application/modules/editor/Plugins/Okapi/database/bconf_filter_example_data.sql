--  (`name`,         `customer_id`,   `default`,   `extensions`,   `description`)
INSERT INTO `LEK_okapi_bconf` (`name`,         `customer_id`,   `default`,   `extensions`,   `description`)
VALUES
...
--  (`okapiId`,   `configId`,                           `okapiName`,                    `mime`,       `default`,   `name`,                         `notes`,                                                                                `extensions`,   `configuration`,                                                                                  `codeId`)
INSERT INTO `LEK_okapi_bconf_filter` (`okapiId`, `configId`, `okapiName`, `mime`, `default`, `name`, `notes`, `extensions`, `configuration`, `codeId`)
VALUES
    ...
    (2,           'okf_simplification-xmlResources',    'XML (Simplified resources)',   'text/xml',   b'0',        'XML (Simplified resources)',   'Configuration for extracting resources from an XML file. Resources are simplified.',   '.xml',         'net.sf.okapi.lib.preprocessing.filters.simplification.SimplificationFilter',                     NULL),
    (3,           'okf_simplification-xmlResources1',   'XML (Simplified resources)',   'text/xml',   b'0',        'XML (Simplified resources)',   'Configuration for extracting resources from an XML file. Resources are simplified.',   '.doc,.pdf',    '#v1\r\nmimeType=new\r\nfileNames=*.tmx,*.xlf,*.xlff\r\nconfigIds=okf_tmx,okf_xliff,okf_xliff',   NULL);

--    (`configId`,                           `mimeType`,               `name`,                                            `extensions`,       `description`)
INSERT INTO `LEK_okapi_bconf_default_filter` (`configId`, `mimeType`, `name`, `extensions`, `description`)
VALUES
