...
{
    public const HEADER_FILTER = "FFD";

    public const HEADER_SECURE_SEG = "SecureSeg";

    public const HEADER_HISTORY_OPT = "HistoryOpt";

    public const UNICODE_BOM_LE = "\xFF\xFE";

    public const UNICODE_BOM_BE = "\xFE\xFF";
