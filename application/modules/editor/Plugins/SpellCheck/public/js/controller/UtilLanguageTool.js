...
Ext.define('Editor.plugins.SpellCheck.controller.UtilLanguageTool', {
     ...
     */
    startSpellCheckAfterCheckingSupportedLanguagesWithTool: function() {
        var me = this,
            url = me.urlLanguages;
        Ext.Ajax.request({
            url:url,
            ...
            success: function(response){
                ...
                // me.setSupportedLanguages(supportedLanguages);
            },
    ...
    /**
     * Checks if language is supported and
     * (1) stores the result in me.isSupportedLanguage[me.taskId]
     * (2) calls 'startSpellCheck' if the language is supported.
     * @param {Array} supportedLanguages
     */
    setSupportedLanguages: function (supportedLanguages) {
        var me = this
            targetLangCode = me.getTargetLangCodeByTaskId(me.taskId);
        me.isSupportedLanguage[me.taskId] = false;
        Ext.Array.each(supportedLanguages, function(lang, index) {
            if (lang.code == targetLangCode) {
                ...
                me.isSupportedLanguage[me.taskId] = true;
                me.startSpellCheck();
                return false;
            }
        });
        // If startSpellCheck() has not been called, nothing more happens now.
    },
    /**
     * 
     * @param {String} text
