...
class editor_Plugins_SpellCheck_SegmentProcessor implements SegmentProcessorInterface
{
     ...
     *
     * @var editor_Plugins_SpellCheck_LanguageTool_Adapter[]
     */
     ...
     *
     * @return editor_Plugins_SpellCheck_LanguageTool_Adapter|null
     */
    public function getConnector($slot = null) {
        ...
        if (!$slot) {
            ...
            $connector = ZfExtended_Factory::get('editor_Plugins_SpellCheck_LanguageTool_Adapter');
        ...
        return self::$connector[$slot] ?? self::$connector[$slot] = ZfExtended_Factory::get('editor_Plugins_SpellCheck_LanguageTool_Adapter', [$slot]);
    }
