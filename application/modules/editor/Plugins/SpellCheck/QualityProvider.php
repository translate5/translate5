...
class editor_Plugins_SpellCheck_QualityProvider extends editor_Segment_Quality_Provider
{
    ...
    public function translateCategoryTooltip(ZfExtended_Zendoverwrites_Translate $translate, string $category, editor_Models_Task $task): string
    {
        return match ($category) {
            ...
            Check::REGISTER => $translate->_('The text is written in the wrong linguistic register or uses slang or other language variants inappropriate to the text.'),
            ...
            Check::NUMBERS => '',
            Check::GRAMMAR => $translate->_('The text contains a grammatical error (including syntax and morphology errors).'),
    ...
    public function translateCategory(
        ...
        return match ($category) {
            ...
            Check::NUMBERS => $translate->_('Number formatting'),
