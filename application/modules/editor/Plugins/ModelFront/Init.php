...
class editor_Plugins_ModelFront_Init extends ZfExtended_Plugin_Abstract
{
    ...
    protected function initEvents()
    {
        ...
        $this->eventManager->attach('editor_LanguageresourceinstanceController', 'afterQueryAction', [$this, 'handleAfterQueryAction']);
        $this->eventManager->attach('editor_Plugins_MatchAnalysis_Pretranslation', 'afterAnalysisSegmentPretranslate', [$this, 'handleAfterAnalysisSegmentPretranslate']);
    }
