...
class Configuration
{
     ...
     * @var integer
     */
    public const OPERATION_TIMEOUT_REQUEST = 300;

    /**
     * Defines the timeout in seconds how long a single segment needs to be tagged
     * @var integer
     */
    public const EDITOR_TIMEOUT_REQUEST = 180;

    /**
     * Defines the timeout in seconds how long the upload and parse request of a TBX may need
     * @var integer
     */
    public const TIMEOUT_TBXIMPORT = 600;

    /**
     * Logger Domain Import
     * @var string
     */
    public const IMPORT_LOGGER_DOMAIN = 'editor.terminology.import';

    /**
     * Logger Domain Editing
     * @var string
     */
    public const EDITOR_LOGGER_DOMAIN = 'editor.terminology.segmentediting';
