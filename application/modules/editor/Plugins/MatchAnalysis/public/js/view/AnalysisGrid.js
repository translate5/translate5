...
Ext.define('Editor.plugins.MatchAnalysis.view.AnalysisGrid', {
    ...
    strings: {
        noMatch: '#UT#No matches',
        matchCount: '#UT#Sum',
        tabTitle: '#UT#Date of the analysis',
        exportAnalysis: '#UT#Export as Excel',
        exportAnalysisXML: '#UT#Export in Trados-style XML',
        noAnalysis: '#UT#No analysis has been created yet. Please start an analysis in the “Language resources” tab',
        languageResources: '#UT#Language resources',
        analysisDate: '#UT#Date',
        languageResourceName: '#UT#Name',
        repetitions: '#UT#Repetitions:',
        internalFuzzy: '#UT#Internal fuzzy matches used',
        matchRate: '#UT#Match rate',
        edit100PercentMatchDisabledMessage: '#UT#Locked 100% matches are not part of the analysis.',
        wordBased:'#UT#word-based',
        characterBased:'#UT#character-based',
        basedOn:'#UT#Based on',
        fromImportedFile:'#UT#From imported file',
        hasErrors: '#UT#During the analysis, {0} error(s) occurred while communicating with the language resources. <br />As a result, the analysis may be incomplete. Please check the task events and system log, and re-run the analysis if necessary.'
    },
