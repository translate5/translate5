...
Ext.define('Editor.plugins.MatchAnalysis.controller.MatchAnalysis', {
    ...
    strings:{
        taskGridIconTooltip:'#UT#Match analysis',
        finishTask:'#UT#Finish',
        analysis:'#UT#Start analysis',
        analysisHint:'#UT#Includes a QA and terminology check',
        preTranslation:'#UT#Start analysis &amp; pre-translation',
        preTranslationTooltip:'#UT#A pre-translation also triggers a new analysis',
        startOperationMsg:'#UT#Match analysis and pre-translations in progress.',
        finishAnalysisMsg:'#UT#The Match analysis and pre-translation have been completed.',
        internalFuzzy:'#UT#With internal fuzzy matches',
        pretranslateMatchRate:'#UT#TM pre-translation match rate',
        pretranslateMatchRateTooltip:'#UT#Use TM matches at or above the selected threshold for pre-translation',
        pretranslateTmAndTerm:'#UT#Pre-translate (TM &amp; terminology)',
        pretranslateTmAndTermTooltip:'#UT#Terminology matches are prioritized in pre-translation',
        pretranslateMt:'#UT#Pre-translate (MT)',
        pretranslateMtTooltip:'#UT#If this option is activated, the segments not pre-translated with the TM will be pre-translated with the MT.',
        analysisLoadingMsg:'#UT#Analysis in progress'
    },
    listen:{
        component:{
