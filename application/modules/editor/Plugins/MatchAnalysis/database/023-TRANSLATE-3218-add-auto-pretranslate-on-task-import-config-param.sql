...
VALUES
('runtimeOptions.plugins.MatchAnalysis.autoPretranslateOnTaskImport', 1, 'editor', 'plugins', '0', '0', '', 'boolean', 4, 'Enable auto pre-translation processing on Task import', 'Enable auto pre-translation processing on Task import', 'Match analysis: defaults');
