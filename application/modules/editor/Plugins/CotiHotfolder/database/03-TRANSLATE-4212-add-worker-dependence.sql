...
('MittagQI\\Translate5\\Plugins\\CotiHotfolder\\Worker\\UploadFinishedTask', 'editor_Models_Export_Worker');

INSERT INTO `Zf_worker_dependencies` (`worker`, `dependency`) VALUES
('MittagQI\\Translate5\\Plugins\\CotiHotfolder\\Worker\\UploadFinishedTask', 'editor_Plugins_Okapi_Worker');