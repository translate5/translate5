...
WHERE `name` = 'runtimeOptions.plugins.CotiHotfolder.defaultPM'
    OR `name` = 'runtimeOptions.plugins.CotiHotfolder.filesystemConfig'
    OR `name` = 'runtimeOptions.plugins.CotiHotfolder.enableAutoExport'
;
