...
WHERE `worker` =  'editor_Segment_Quality_ImportWorker' AND `dependency` = 'editor_Plugins_GlobalesePreTranslation_Worker';

DELETE FROM `Zf_worker_dependencies`
WHERE `worker` =  'editor_Segment_Quality_OperationWorker' AND `dependency` = 'editor_Plugins_GlobalesePreTranslation_Worker';
