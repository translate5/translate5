...
class editor_Plugins_GlobalesePreTranslation_Connector
{
     ...
     */
    public const GLOBALESE_FILESTATUS_OK = 'ok';

    public const GLOBALESE_FILESTATUS_TRANSLATED = 'translated';

    public const GLOBALESE_FILESTATUS_IN_TRANSLATION = 'in_translation';

    public const GLOBALESE_FILESTATUS_ERROR = 'error';
