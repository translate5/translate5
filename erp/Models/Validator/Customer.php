...
class erp_Models_Validator_Customer extends ZfExtended_Models_Validator_Abstract {
    ...
    */
    protected function defineValidators() {
        ...
        $this->addValidator('shortcut', 'stringLength', array('min' => 0, 'max' => 255));
        
        //`keyaccount` int(11) DEFAULT NULL,
        $this->addValidator('keyaccount', 'int', array(), true);
        
        //`taxPercent` decimal(5,4) DEFAULT NULL,
