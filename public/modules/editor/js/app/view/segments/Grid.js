...
Ext.define('Editor.view.segments.Grid', {
    ...
    store: 'Segments',
    title: '#UT#Segment table and editor',
    title_readonly: '#UT#– [READ-ONLY]',
    title_addition_unconfirmed: '#UT#– [TASK NOT APPROVED]',
    column_edited: '#UT#editable',
    target_original: '#UT#(at time of import/pre-translation)',
