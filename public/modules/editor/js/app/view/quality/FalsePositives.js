...
Ext.define('Editor.view.quality.FalsePositives', {
    ...
    requires: ['Editor.view.quality.FalsePositivesController', 'Ext.grid.column.Check'],
            ...
            columns: [
                {
                    ...
                    renderer: function (value, meta, record, rowIndex, colIndex, store, view) {
                        let me = this,
                            cls = me.checkboxCls,
                            tip = Ext.htmlEncode(Editor.data.l10n.falsePositives.grid.rowTip);
                        ...
                        if (rowIndex < 10) {
                            tip =
                                'Ctrl + Alt + ' + (rowIndex === 9 ? 0 : rowIndex + 1) + '. ' + tip;
                        }

                        return `<span data-qtip="${tip}" class="${cls}" role="${me.checkboxAriaRole}"${!me.ariaStaticRoles[me.checkboxAriaRole] ? ' tabIndex="0"' : ''}></span>`;
                    },
                    listeners: {
