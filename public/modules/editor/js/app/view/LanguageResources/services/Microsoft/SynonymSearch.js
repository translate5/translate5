...
Ext.define('Editor.view.LanguageResources.services.Microsoft.SynonymSearch', {
    ...
    strings: {
        synonymSearch: '#UT#Synonym search',
        resultColumn:'#UT#Translation',
        partOfSpeechColumn:'#UT#Part of speech',
        backTranslationsColumn:'#UT#Alternatives',
        confidenceColumn:'#UT#Probability',
        ADJ:'#UT#adjective',
        ADV:'#UT#adverb',
        CONJ:'#UT#Connection',
        DET:'#UT#determiner',
        ...
        OTHER:'#UT#Other',
        unknown:'#UT#unknown',
        searchSourceInfoText:'#UT#Searches in the source language'
    },
