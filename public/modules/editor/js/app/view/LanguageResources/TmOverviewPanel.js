...
Ext.define('Editor.view.LanguageResources.TmOverviewPanel', {
    ...
    strings: {
        ...
        edit: '#UT#Edit',
        erase: '#UT#Delete',
        tasks: '#UT#Associated tasks',
        resource: '#UT#Resource',
        color: '#UT#Colour',
        refresh: '#UT#Refresh',
        addResource: '#UT#Add language resource',
        noTaskAssigned: '#UT#No tasks associated.',
        sourceLang: '#UT#Source language',
        targetLang: '#UT#Target language',
        languageResourceStatusColumn: '#UT#Status',
        languageResourceStatus: {
            loading: '#UT#Status information is loaded',
            error: '#UT#Error',
            available: '#UT#available',
            unknown: '#UT#unknown',
            noconnection: '#UT#No connection!',
            import: '#UT#importing',
            notloaded: '#UT#available',
            notchecked: '#UT#Not checked',
            novalidlicense: '#UT#No valid license.',
            tuninginprogress: '#UT#Training in progress',
            reorganize_in_progress: '#UT#Reorganization in progress',
            reorganize_failed: '#UT#Reorganization failed',
            converting: '#UT#Converting',
        },
        customers: '#UT#Clients',
        ...
        specificDataText: '#UT#Additional info',
        pivotAsDefault: '#UT#Use as pivot by default',
        tmNotConverted: '#UT#The content protection rules for this resource have changed, it needs conversion.',
    },
    cls: 'tmOverviewPanel',
    height: '100%',
    layout: {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        renderer: function (v, meta) {
                            ...
                            meta.tdAttr =
                                'data-qtip="' + Ext.String.htmlEncode(tasks.join('<br />•••••••••••<br />')) + '"';
                    ...
                    },
                    {
                        ...
                        filter: {
                            ...
                            options: [
                                {
                                    id: 'showTaskTms',
                                    text: Editor.data.l10n.tmOverview.showTaskTm,
                                },
                                {
                                    id: 'hideTaskTms',
                                    text: Editor.data.l10n.tmOverview.hideTaskTm,
                                },
                            ],
                            single: true,
                        },
    ...
    createSpecificDataTooltip: function updateTipBody(tip) {
        ...
        if (
            specificData.hasOwnProperty('version') &&
            typeof specificData.version === 'object' &&
            specificData.version.hasOwnProperty('version')
        ) {
    ...
    localizeSpecificDataKey: function (key, serviceName) {
        if (
            Editor.data.l10n.languageResources.specificData.hasOwnProperty(serviceName) &&
