...
Ext.define('Editor.view.admin.contentProtection.outputMapping.GridController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.Editor.view.admin.contentProtection.outputMapping.GridController',
    ...
    deleteOutputMapping: function(view, rowIdx, colIdx, actionCfg, evt, rec) {
        Ext.MessageBox.confirm(
            ...
            btn => btn === 'yes' && Ext.Ajax.request({
                url: Editor.data.restpath + 'contentprotectionoutputmapping',
                method: 'DELETE',
                params: {
                    id : rec.get('id')
                },
    ...
    createOutputMapping: function () {
        ...
        const newRecord = Ext.create('Editor.view.admin.contentProtection.outputMapping.Model');
