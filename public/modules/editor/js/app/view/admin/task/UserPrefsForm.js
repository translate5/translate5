...
Ext.define('Editor.view.admin.task.UserPrefsForm', {
    ...
    bodyPadding: 10,
    autoScroll: true,
    title_edit: '#UT#Edit entry: “{0} – {1}”',
    title_add: '#UT#Create entry',
    strings: {
        fieldStep: '#UT#Workflow step',
        fieldUsername: '#UT#Users',
        fieldTargets: '#UT#available columns',
        fieldNotEditContent: '#UT#Edit only manual QA inside segments',
        fieldAnonymous: '#UT#anonymized target text columns',
        fieldVisibility: '#UT#Visibility of the non-editable target columns',
        btnSave: '#UT#Save',
        btnCancel: '#UT#Cancel',
        visShow: '#UT#Show',
        visHide: '#UT#Hide',
        visDisabled: '#UT#not available',
        forAll: '#UT#for all'
    },
