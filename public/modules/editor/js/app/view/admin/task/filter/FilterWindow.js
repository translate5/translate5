...
Ext.define('Editor.view.admin.task.filter.FilterWindow', {
    ...
    strings: {
        ...
        workflowUserRoleLabel: '#UT#Type of workflow step',
        workflowUserRoleTip: '#UT#Filters all tasks that have a job assigned with the selected workflow step type',
        workflowLabel: '#UT#Workflow',
        workflowStepLabel: '#UT#Workflow step',
        workflowStepTip: '#UT#Filters all tasks that have a job assigned with the selected workflow step',
        userNameLabel: '#UT#Assigned user(s)',
        applyBtn: '#UT#Apply',
        cancelBtn: '#UT#Cancel',
        title: '#UT#Advanced filters',
        anonymizedUsersInfo: '#UT#Anonymized users not selectable',
        gridFiltersInfo: '#UT#More filters in the head of each column',
        assignmentDateText: '#UT#Assignment date of user/s',
        finishedDateText: '#UT#Finish date of user/s',
        deadlineDateText: '#UT#Deadline of user/s',
        type: '#UT#Type',
        translatorStep: '#UT#Translation',
        reviewerStep: '#UT#Review',
        translatorCheckStep: '#UT#Final review',
        visitorStep: '#UT#Read only',
        min:'#UT#min',
        max:'#UT#max',
        matchRate:'#UT#Match rate',
        resourceType:'#UT#Resource type',
        langResources:'#UT#Language resources'
    },
    listeners:{
