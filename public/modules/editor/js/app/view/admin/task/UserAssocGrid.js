...
Ext.define('Editor.view.admin.task.UserAssocGrid', {
    ...
    strings: {
        ...
        confirmDeleteCoordinatorGroupJob: '#UT#Should this entry really be deleted? This entry is a Coordinator group job and by deleting it, all subgroup jobs as well as related Coordinator group user jobs will be deleted.',
        userGuidCol: '#UT#Users',
        typeCol: '#UT#Type',
        roleCol: '#UT#Role',
        stepCol: '#UT#Workflow step',
        segmentrangeCol: '#UT#Segments',
        stateCol: '#UT#Status',
        addUser: '#UT#Add',
        ...
        reload: '#UT#Refresh',
        cancel: '#UT#Cancel',
        assignmentDateLable: '#UT#Assignment',
        finishedDateLabel: '#UT#Finished',
        deadlineDateLable: '#UT#Deadline',
        userSpecialProperties: '#UT#Special',
        notifyUsersTitle: '#UT#Notify assigned users?',
        notifyUsersMsg: '#UT#Do you want to notify the associated users about their task association?',
        userNotifySuccess: '#UT#Users were successfully notified by e-mail',
        notifyButtonText: '#UT#Notify users',
        notifyButtonTooltip: '#UT#Notify all assigned users about their assignment via e-mail',
    },
    states: {
        edit: '#UT#work in progress'
    },
    border: 0,
    plugins: ['gridfilters'],
