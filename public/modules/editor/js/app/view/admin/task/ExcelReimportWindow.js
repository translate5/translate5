...
Ext.define('Editor.view.admin.task.ExcelReimportWindow', {
    ...
    title: '#UT#Re-import Excel file',
    strings: {
        info: '#UT#Re-import the previously downloaded Excel file back into the task.',
        reimportUploadType: '#UT#Only XLSX files are allowed.',
        uploadBtn: '#UT#Upload Excel',
        cancelBtn: '#UT#Cancel',
        closeBtn: '#UT#Close',
        loadingWindowMessage: '#UT#uploading file',
    },
    modal : true,
    layout: 'anchor',
    autoScroll: true,
