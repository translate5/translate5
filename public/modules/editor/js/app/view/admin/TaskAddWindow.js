...
Ext.define('Editor.view.admin.TaskAddWindow', {
    ...
    title: '#UT#Create project',
    defaultFocus: '#customerId',
    strings: {
        importUploadTip: '#UT#Select the data to be imported (information required)',
        importUploadLabel: '#UT#Import file¹',
        importUploadType: '#UT#The file format of the selected file is not supported!',
        importNews: '#UT#<a target="_blank" href="https://confluence.translate5.net/display/BUS/Supported+file+formats">More information</a> on supported file formats.',
        taskNrLabel: '#UT#Order number',
        taskNameTip: '#UT#Task name (user-selectable, required)',
        taskNameLabel: '#UT#Project name&lt;sup&gt;1&lt;/sup&gt;',
        sourceLangTip: '#UT#Source language of the task (required)',
        sourceLangLabel: '#UT#Source language¹',
        targetLangTip: '#UT#Target language of the task (required)',
        targetLangLabel: '#UT#Target language¹',
        relaisLangTip: '#UT#Pivot language (required if pivot data is available)',
        relaisLangLabel: '#UT#Pivot language',
        numberFieldLabel: '#UT#Number of words',
        orderdate: '#UT#Order date',
        fullMatchLabel: '#UT#Edit unchanged 100% TM matches',
        lockLockedLabel: '#UT#For SDLXLIFF import files only: Explicitly locked segments in files are also locked in translate5',
        sourceEditLabel: '#UT#Source text is editable',
        bottomInfo: '#UT#¹ This information/data is mandatory for the import.',
        feedbackText: '#UT#Import error!',
        feedbackTip: '#UT#Import error: Please contact the support!',
        addBtn: '#UT#Import task',
        addBtnWizard: '#UT#Import (skip next steps)',
        btnNextWizard:'#UT#Next',
        cancelBtn: '#UT#Cancel',
        btnSkip:'#UT#Import (skip next steps)',
        importDefaultsButtonText:'#UT#Import (use defaults)',
        description: '#Projektbeschreibung',
        autoRemovedUploadFilesWarningMessage:'#UT#All matching bilingual files for this language will be removed from the list of uploaded files.',
