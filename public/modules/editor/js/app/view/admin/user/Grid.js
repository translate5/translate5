...
Ext.define('Editor.view.admin.user.Grid', {
  ...
  text_cols: {
      login: '#UT#Login',
      firstName: '#UT#Forename',
      surName: '#UT#Surname',
      gender: '#UT#Salutation',
      email: '#UT#E-mail',
      locale: '#UT#Language',
      roles: '#UT#System roles',
      openIdIssuer:'#UT#OpenID issuer'
  },
  strings: {
      addUser: '#UT#Add user',
      addUserTip: '#UT#Add a new user.',
      actionEdit: '#UT#Edit user',
      actionDelete: '#UT#Delete user',
      actionResetPw: '#UT#Reset user password, user is notified by e-mail',
      gender_female: '#UT#Ms.',
      gender_male: '#UT#Mr.',
      gender_neutral: '#UT#not specified',
      reloadBtn: '#UT#Refresh',
      reloadBtnTip: '#UT#Reload users from server',
      localeTooltip:'#UT#User GUI language'
  },
  store: 'admin.Users',
  viewConfig: {
      /**
