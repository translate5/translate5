...
Ext.define('Editor.view.admin.config.Grid', {
    ...
    strings: {
        title:'#UT#System configuration',
        id:'#UT#Value',
        name:'#UT#Code ID',
        guiName:'#UT#Short name',
        value:'#UT#Value',
        editRecordTooltip:'#UT#Edit configuration',
        saveRecordTooltip:'#UT#Save',
        description:'#UT#Description',
        reloadBtn: '#UT#Refresh',
        overwriteOrigin : '#UT#Set on level',
        configActiveColumn:'#UT#Enabled',
        configDeactiveColumn:'#UT#Disabled',
        updateConfigSuccessMessage:'#UT#Configuration saved',
        configChangeReloadMessageBoxText:'#UT#This change will take effect after the next login. This also applies to other users who are currently logged in.',
        collapseAll:'#UT#Collapse all',
        expandAll:'#UT#Expand all',
        toolbarFilter:'#UT#Search',
        overwriteLevelList:'#UT#Overwritable at level:',
        readOnlyFilter:'#UT#Show write-protected',
        configLocales:{
            default:'#UT#Default',
            aria:'#UT#Dark layout (Aria)',
