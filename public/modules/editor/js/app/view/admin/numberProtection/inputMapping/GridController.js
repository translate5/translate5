...
Ext.define('Editor.view.admin.numberProtection.inputMapping.GridController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.Editor.view.admin.numberProtection.inputMapping.GridController',
    ...
    createInputMapping: function () {
        ...
        const newRecord = Ext.create('Editor.view.admin.numberProtection.inputMapping.Model');
