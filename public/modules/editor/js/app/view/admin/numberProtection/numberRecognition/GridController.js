...
Ext.define('Editor.view.admin.numberProtection.numberRecognition.GridController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.Editor.view.admin.numberProtection.numberRecognition.GridController',
    ...
    deleteNumberRecognition: function(view, rowIdx, colIdx, actionCfg, evt, rec) {
        ...
        Ext.MessageBox.confirm(
            ...
            Editor.data.l10n.numberProtection.numberRecognition.confirm_deletion_message,
            callback
        );
    },

    onNumberRecognitionEdit: function(plugin, context) {
        context.record.save({
    ...
    createNumberRecognition: function () {
        ...
        const newRecord = Ext.create('Editor.view.admin.numberProtection.numberRecognition.Model');
