...
Ext.define('Editor.view.admin.numberProtection.inputMapping.CreateWindowViewController', {
    ...
    saveNewInputMapping: function() {
        var me = this,
            ...
            store = Ext.StoreManager.get('admin.numberProtection.InputMappingStore');
