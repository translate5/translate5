...
Ext.define('Editor.view.admin.ExportMenu', {
    ...
    itemId: 'exportMenu',
    messages: {
        exportDef: '#UT#Original format, {0}',
        transfer: '#UT#Transfer translated terms to TermCollection(s)',
        exportTranslation: '#UT#translated',
        exportReview: '#UT#reviewed',
        exportDiff: '#UT#SDLXLIFF with track changes',
        export2Def: '#UT#XLIFF 2.1',
        exportQmField: '#UT#Export QA statistics (XML) for field: {0}',
        exportExcel: '#UT#Export for external editing (XLSX)',
        exportExcelHistory: '#UT#Export editing history per workflow-step (XLSX)',
        downloadImportArchive: '#UT#Download import archive',
        faultyQualityAlertTitle: '#UT#Warning',
        faultyQualityAlertText: '#UT#There are problems with internal tags in this task that have been automatically resolved for a proper export',
    },
