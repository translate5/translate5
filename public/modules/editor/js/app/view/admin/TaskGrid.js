...
Ext.define('Editor.view.admin.TaskGrid', {
    ...
    text_cols: { // in case of any changes, pls also update TASKGRID_TEXTCOLS in editor_Models_Task
        ...
        taskActions: '#UT#Actions',
        state: '#UT#Status (task)',
        customerId: '#UT#Client',
        taskName: '#UT#Name',
        taskNr: '#UT#Order no.',
        wordCount: '#UT#Words',
        wordCountTT: '#UT#Number of words',
        fileCount: '#UT#Files',
        sourceLang: '#UT#Source language',
        relaisLang: '#UT#Pivot language',
        targetLang: '#UT#Target language',
        referenceFiles: '#UT#Reference files',
        terminologie: '#UT#Terminology',
        userCount: '#UT#Number of assigned users',
        users: '#UT#Users',
        taskassocs: '#UT#Number of assigned language resources',
        pmName: '#UT#Project manager',
        pmGuid: '#UT#Project manager',
        orderdate: '#UT#Order date',
        enddate: '#UT#Ended date',
        edit100PercentMatch: '#UT#100% matches editable',
        fullMatchEdit: '#UT#Edit unchanged 100% TM matches',
        emptyTargets: '#UT#Translation job (no review)',
        lockLocked: '#UT#For SDLXLIFF import files only: Explicitly locked segments in files are also locked in translate5',
        enableSourceEditing: '#UT#Source language editable',
        workflowState: '#UT#Workflow status',//Not a task grid column header, used only for advanced filter label in the tag field
        workflowUserRole: '#UT#Type of workflow step',//The same as above
        userName: '#UT#Users',//The same as above
        segmentCount: '#UT#Segment count',
        segmentFinishCount: '#UT#% finished',
        id: '#UT#ID',
        taskGuid: '#UT#Task GUID',
        workflowStepName: '#UT#Current workflow step',
        userState: '#UT#My job status',
        userJobDeadline: '#UT#My job deadline',
        assignmentDate: '#UT#Assignment date of user/s',
        finishedDate: '#UT#Finish date of user/s',
        deadlineDate: '#UT#Deadline of user/s',
        //Active filter labels below
        langResource: '#UT#Language resources',
        langResourceType: '#UT#Resource type',
        matchRateMin: '#UT#Match rate',
        matchRateMax: '#UT#Match rate',
        qualityScoreMin: '#UT#Quality estimation',
        qualityScoreMax: '#UT#Quality estimation',
    },
    strings: {
        deadlineDateHeader: '#UT#Deadline date',
        assignmentDateHeader: '#UT#Assignment date',
        finishedDateHeader: '#UT#Completion date',
        noRelaisLang: '#UT#– no pivot language –',
        ended: '#UT#ended',
        noUsers: '#UT#No user assigned!',
        notFound: '#UT#not found',
        locked: '#UT#work in progress',
        lockedBy: '#UT#Edited and locked by {0}',
        lockedMultiUser: '#UT#In progress by:',
        lockedSystem: '#UT#Locked by the system with status “{0}”',
        addProject: '#UT#Add project',
        addProjectTip: '#UT#Add new project',
        exportMetaDataBtn: '#UT#Export meta data',
        exportMetaDataBtnTip: '#UT#Export meta data for all filtered tasks.',
        showKPIBtn: '#UT#Show KPIs',
        showKPIBtnTip: '#UT#Show KPIs for all filtered tasks.',
        reloadBtn: '#UT#Refresh',
        reloadBtnTip: '#UT#Refresh task list from the server',
        emptyTargets: '#UT#Translation job – all target elements of the  segments have been empty at import time (not checked means this is a review job)',
        currentWorkflowStepProgressTooltip: '#UT#% completed by assigned users in the current workflow step',
        addFilterText: '#UT#Advanced filters',
        jobStatus: '#UT#Job status',
        exelExportedTooltip: '#UT#Locked as exported to Excel for external review. Re-import Excel to unlock. If Excel is not at hand: export again.',
        enddateTooltip: '#UT#The date on which the project manager set the task to “ended”, not the date on which individual workflow steps were completed.',
