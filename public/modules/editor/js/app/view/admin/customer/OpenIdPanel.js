...
Ext.define('Editor.view.admin.customer.OpenIdPanel', {
    ...
    strings:{
        save:'#UT#Save',
        cancel:'#UT#Cancel',
        saveCustomerMsg:'#UT#Client is being saved...',
        customerSavedMsg:'#UT#Client saved!',
        openIdServer:'#UT#OpenID server',
        openIdIssuer:'#UT#OpenID issuer',
        openIdClientId:'#UT#OpenID user name',
        openIdClientSecret:'#UT#OpenID password',
        openIdAuth2Url:'#UT#OpenID OAuth URL',
        defaultRolesGroupLabel: '#UT#Default roles',
        serverRolesGroupLabel: '#UT#Allowed roles',
        openIdRedirectLabel:'#UT#Linked text on login page',
        openIdRedirectCheckbox:'#UT#Do not show login page: Automatically redirect to OpenID Connect server if there is no user session in translate5. If this checkbox is not activated, the text defined in the text box below will be linked to the OpenID Connect server on the login page of translate5.',
        defaultRolesGroupLabelTooltip: '#UT#Default system roles are used, if the OpenID server does not pass any system roles for the user that logs on.',
        serverRolesGroupLabelTooltip: '#UT#System roles that the OpenID server is allowed to set in translate5.',
        helpButtonText:'#UT#Help',
        ssoText:'#UT#Single Sign-on',
        thisFieldIsRequiredText:'#UT#This field can not be empty'
    },
