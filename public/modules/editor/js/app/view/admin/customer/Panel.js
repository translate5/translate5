...
Ext.define('Editor.view.admin.customer.Panel', {
    ...
    strings: {
        ...
        customerName: '#UT#Client name',
        customerNumber: '#UT#Client number',
        save: '#UT#Save',
        cancel: '#UT#Cancel',
        remove: '#UT#Delete',
        addCustomerTitle: '#UT#Add client',
        saveCustomerMsg: '#UT#Client is being saved...',
        customerSavedMsg: '#UT#Client saved!',
        customerDeleteMsg: '#UT#Delete this client?',
        customerDeleteTitle: '#UT#Delete client',
        customerDeletedMsg: '#UT#Client deleted',
        export: '#UT#Resource usage export',
        domain: '#UT#Website address (domain only)',
        propertiesTabPanelTitle: '#UT#General',
        configTabTitle:'#UT#System configuration overwrites',
        actionColumn:'#UT#Actions',
        customerEditActionIcon:'#UT#Edit client profile',
        openIdTabPanelDisabledTooltip:'#UT#Please configure the “Website address (domain only)” field in the “General” tab first. After that, you can set up OpenID Connect for this client.'
    },
    shrinkWrap: 0,
    layout: 'border',
    collapsed: false,
