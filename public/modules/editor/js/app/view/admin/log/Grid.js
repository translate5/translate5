...
Ext.define('Editor.view.admin.log.Grid', {
    ...
    strings: {
        reload: '#UT#Refresh',
        level: '#UT#Type',
        level_fatal: '#UT#Fatal error',
        level_error: '#UT#Error',
        level_warn: '#UT#Warning',
        level_info: '#UT#Info',
        level_debug: '#UT#Debug',
        level_trace: '#UT#Trace',
        colUsername: '#UT#Users',
        eventCode: '#UT#Code',
        eventCodeLong: '#UT#Event code / error code',
        domain: '#UT#Domain',
        message: '#UT#Event',
        created: '#UT#Date / time',
        moreInfo: '#UT#more information',
        eventCodeInfoText : '#UT#For more information about the event, click on the event code.<br/>Not all errors can be listed here. Therefore, please also check the <a href="#preferences/adminSystemLog">general system log</a>!'
    },
    layout: 'fit',
    entityUrlPart: null,
