...
Ext.define('Editor.controller.TmOverview', {
    ...
    strings: {
        deleteConfirm: '#UT#Permanently delete language resource?',
        deleteConfirmText: '#UT#Do you really want to permanently delete the language resource “{0}”?',
        deleteConfirmLocal: '#UT#Delete language resource?',
        deleteConfirmLocalText: '#UT#Do you want to delete the selected language resource „{0}“ from the list shown here? <br /> No data will be deleted in the linked TM system as there is no connection.',
        deleted: '#UT#Language resource “{0}” deleted.',
        edited: '#UT#The language resource “{0}” was successfully changed.',
        created: '#UT#The language resource “{0}” was successfully created.',
        noResourcesAssigned: '#UT#No language resources associated.',
        taskassocgridcell: '#UT#Associated language resources',
        exportTm: '#UT#export as TM file',
        exportTmx: '#UT#export as TMX file',
        exportZippedTmx: '#UT#export as zipped TMX file',
        mergeTermsWarnTitle: '#UT#Not recommended!',
        mergeTermsWarnMessage: '#UT#Terms in the TBX will always be merged first by ID with existing entries in the TermCollection. If “Merge terms” is checked and the ID in the TBX is not found in the TermCollection, it will be checked whether the same term already exists in the same language. If yes, the entire term entries will be merged. Especially with a TermCollection with many languages, this may lead to unwanted results.',
        importing: '#UT#Language resource {0} is being imported at the moment. Please wait until the import is finished.',
        beingTrained: '#UT#Language resource {0} is currently being trained. Please wait until the training has finished.',
        deletionForbidden: '#UT#You are not allowed to remove this language resource.',
        error: '#UT#Error'
    },
    refs: [{
        ref: 'tmOverviewPanel',
