...
Ext.define('Editor.controller.Editor', {
    ...
    messages: {
        segmentReset: '#UT#The segment content was reset to its original import state.',
        segmentNotBuffered: '#UT#The previous/next segment is still loading, please try again.',
        segmentStillSaving: '#UT#The previous/next segment is still saving, please wait...',
        segmentsChanged: '#UT#The segment sort or filter was changed, no next/previous segment can be selected.',
        segmentsChangedJump: '#UT#The segment sort or filter was changed, the currently opened segment cannot be scrolled back into the view.',
        f2FirstOpened: '#UT#The first editable segment was opened for editing, as no other segment was selected.',
        f2Readonly: '#UT#The selected segment is not editable!',
        errorTitle: '#UT#Error during segment validation!',
        correctErrorsText: '#UT#Correct errors',
        editorMoveTitle: '#UT#Moveable editor and useful keyboard short-cuts',
        editorMove: '#UT#The segment editor can be positioned as desired using the mouse.<br />Simply left-click on the segment editor and then move it.',
        takeTagTooltip: '#UT#CTRL + INS (alternatively CTRL + . (period)) copies the complete source segment content into the target segment<br />CTRL + , (comma) + &gt;number&lt; copies the corresponding tag (zero equals tag no. 10) into the target segment<br />CTRL + SHIFT + , (comma+ &gt;number&lt; copies tags 11 to 20 into the target segment.',
        saveAnyway: '#UT#Save anyway',
        doubleclickToTakeMatch: '#UT#Double-click to apply the match to the open segment.',
        noVisibleContentColumn: '#UT#Hidden editable columns have been made visible because the task was opened for editing, but no editable columns were visible.',
        gridEndReached: '#UT#No more segments are editable!',
        gridStartReached: '#UT#No previous segment is editable!',
        gridEndReachedWorkflow: '#UT#No further segment in the workflow can be edited!',
        gridEndReachedFiltered: '#UT#No further segments in the current filtering',
        gridStartReachedWorkflow: '#UT#No previous segment in the workflow is editable!',
        gridStartReachedFiltered: '#UT#No previous segments in the current filtering'
    },
