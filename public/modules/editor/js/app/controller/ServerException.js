...
Ext.define('Editor.controller.ServerException', {
    ...
    strings: {
        "403": '#UT#You do not have the necessary permissions for the requested data!',
        "403_destroy": '#UT#You do not have the necessary rights to delete the data!',
        "403_create": '#UT#You do not have the necessary rights to save new data!',
        "403_update": '#UT#You do not have the necessary rights to save the edited data!',
        "403_edit": '#UT#You do not have the necessary rights to save the edited data!',
        "404": '#UT#The requested data was not found.',
        "405_del_assoc": '#UT#A user could not be removed from the task, because he is currently using the task.',
        "401_title": '#UT#Sign in again',
        "401_msg": '#UT#Your session has expired. You will be redirected to the login page.',
        "406": '#UT#An error occurred!',
        "409": '#UT#Your data could not be saved; a conflict occurred while saving!',
        "503_title": '#UT#Maintenance is in progress',
        "503_msg": '#UT#Maintenance in progress. The system will be available again once maintenance is complete.',
        "update_title": '#UT#Translate5 was updated to a new version',
        "update_msg": '#UT#An update to version {0} was done. Please reload the application to avoid errors during use.',
        title: '#UT#Error',
        text: '#UT#Error while saving or reading data. Please contact our support team!',
        timeout: '#UT#The request to the server via the Internet took too long. This may be due to your internet connection or an overload on the server. Please try again.',
        serverMsg: '#UT#<br />Server message: <i>{0} {1}</i>'
    },
